...
node scripts/forge.mjs lumara-valle-de-las-chispas all

# one image, fast iteration mode (NB2, cheaper)
node scripts/forge.mjs lumara-valle-de-las-chispas cover-v2 --fast

# one image at finished-art quality
node scripts/forge.mjs lumara-valle-de-las-chispas spread-ch07

# all spreads, fast iteration
node scripts/forge.mjs lumara-valle-de-las-chispas all --fast
```

Output → `apps/web/public/images/books/lumara-valle-de-las-chispas-<scene>.png`

## Iterating on a prompt

The slowest part of great art is the rewriting. Workflow:

1. `node scripts/forge.mjs lumara-valle-de-las-chispas cover-v2 --fast` →
   look at the image
