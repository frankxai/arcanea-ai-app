...
> *"Know the map, and you will not be lost."*
...
The journey through territories mirrors the Arc of existence:
- **Borderlands → Plains** — Potential becomes Manifestation
- **Forest → Mountains** — Experience deepens through challenge
- **Valley** — The heart of Manifestation
- **Desert** — Dissolution, the necessary darkness
- **Highlands** — Evolved Potential, carrying wisdom forward

The special territories (Islands of Flow, Shadowlands, Threshold) are places outside the main Arc—moments of grace or crisis that interrupt the pattern.

---

## How to Use

- **To find your location:** Read each region's description. Which resonates?
- **To navigate forward:** Read the navigation guidance for your current territory
- **When stuck:** Consult the special territories section
- **For perspective:** Read the complete atlas to see the whole journey

---

## Guardians as Guides

Each Guardian can serve as guide through specific territories:
- **Lyssandria** guides through the Borderlands (Foundation)
