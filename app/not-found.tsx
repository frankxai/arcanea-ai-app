import { Sparkles, Home, Search, BookOpen } from 'lucide-react'
      ...
      <div className="relative max-w-2xl w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <Sparkles className="relative w-24 h-24 text-arcane-void-bright animate-bounce" />
          </div>
        </div>

        {/* 404 text */}
        <h1 className="text-9xl font-display text-gradient-cosmic mb-4">
          404
        </h1>
          ...
          >
            <div className="mb-4 flex justify-center">
              <div className="p-3 bg-arcane-crystal/10 rounded-xl group-hover:scale-110 transition-transform duration-300">
                <Home className="w-8 h-8 text-arcane-crystal" />
              </div>
            </div>
            <h3 className="text-white font-display text-base mb-2">Home</h3>
            <p className="text-text-muted font-body text-sm">Return to the beginning</p>
          </Link>
          ...
          >
            <div className="mb-4 flex justify-center">
              <div className="p-3 bg-arcane-void/10 rounded-xl group-hover:scale-110 transition-transform duration-300">
                <Search className="w-8 h-8 text-arcane-void-bright" />
              </div>
            </div>
            <h3 className="text-white font-display text-base mb-2">Explore</h3>
            <p className="text-text-muted font-body text-sm">Discover existing worlds</p>
          </Link>
          ...
          >
            <div className="mb-4 flex justify-center">
              <div className="p-3 bg-arcane-fire/10 rounded-xl group-hover:scale-110 transition-transform duration-300">
                <BookOpen className="w-8 h-8 text-arcane-fire" />
              </div>
            </div>
            <h3 className="text-white font-display text-base mb-2">Guardians</h3>
            <p className="text-text-muted font-body text-sm">Meet your AI companions</p>
          </Link>
        </div>
        ...
        <p className="text-text-muted font-body text-sm">
          Lost? Check out our{' '}
          <Link href="/dashboard" className="text-arcane-crystal hover:text-arcane-crystal-bright underline transition-colors">
            dashboard
          </Link>{' '}
          or{' '}
          <Link href="/chat" className="text-arcane-crystal hover:text-arcane-crystal-bright underline transition-colors">
