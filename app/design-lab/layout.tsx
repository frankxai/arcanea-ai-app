              ...
              >
                {current && (
                  <>
                    ...
                    <span className="text-sm font-sans font-medium text-white hidden sm:inline">{current.label}</span>
                    <span className="text-sm font-sans font-medium text-white sm:hidden">{current.id.toUpperCase()}</span>
                ...
                return (
                  ...
                  >
                    <div className={cn(
                      ...
                      isActive ? 'bg-arcane-crystal/20 text-arcane-crystal' : 'bg-white/5 text-text-muted'
                    )}>
                      {i + 1}
                    </div>
                    <Icon className={cn('w-4 h-4 shrink-0', isActive ? v.color : 'text-text-muted')} />
