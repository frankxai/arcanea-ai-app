  ...
  return (
    <div className="relative w-[280px] h-[280px] sm:w-[360px] sm:h-[360px] mx-auto">
        ...
        {elements.map((el) => (
          ...
          >
            <div
              ...
              style={{ backgroundColor: el.color, boxShadow: `0 0 20px ${el.color}60` }}
            />
          </motion.div>
        ))}
      </motion.div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          <Gem className="w-8 h-8 sm:w-10 sm:h-10 text-arcane-crystal" />
        </motion.div>
      </div>
...
const evolutionStages = [
  { id: 'v1', label: 'Foundation', desc: 'Cosmic palette, elemental colors, fluid typography, font system', icon: Palette, color: '#7fffd4', element: 'Crystal' },
  { id: 'v2', label: 'Components', desc: 'CVA buttons, badges, inputs, cards with elemental variants', icon: Component, color: '#78a6ff', element: 'Water' },
  { id: 'v3', label: 'Motion', desc: '40+ CSS keyframes, 30+ Framer Motion variants, spring physics', icon: Sparkles, color: '#9966ff', element: 'Void' },
  { id: 'v4', label: 'Effects', desc: 'Glass morphism, glow systems, gradient borders, cosmic mesh', icon: Layers, color: '#ff6b35', element: 'Fire' },
  { id: 'v5', label: 'Layout', desc: 'Container widths, spacing scale, responsive grids, spatial rhythm', icon: Layout, color: '#00ff88', element: 'Wind' },
  { id: 'v6', label: 'Guardians', desc: 'Ten guardian palettes, frequency-driven tokens, elemental design', icon: Shield, color: '#ffd700', element: 'Gold' },
  { id: 'v7', label: 'Responsive', desc: 'WCAG compliance, touch targets, reduced motion, device testing', icon: Smartphone, color: '#8b7355', element: 'Earth' },
  { id: 'v8', label: '3D & Spatial', desc: 'Three.js patterns, WebXR integration, performance tiers', icon: Box, color: '#7fffd4', element: 'Crystal' },
  { id: 'v9', label: 'AI Patterns', desc: 'Multi-LLM routing, generation UI, Guardian AI personalities', icon: Brain, color: '#9966ff', element: 'Void' },
  { id: 'v10', label: 'Future Vision', desc: 'Container queries, view transitions, scroll-driven animations', icon: Telescope, color: '#ffd700', element: 'Gold' },
]

const principles = [
  { icon: Eye, title: 'Cosmic Clarity', desc: 'Dark backgrounds with luminous accents. Every element guides the eye through deliberate information hierarchy.', size: 'large' as const },
  { icon: Sparkles, title: 'Mythic Modernity', desc: 'Cinzel display meets Inter UI. Ancient gravitas, pixel-perfect precision.', size: 'small' as const },
  { icon: Heart, title: 'Elemental Emotion', desc: 'Five elements, ten guardians — distinct color, glow, and motion signatures.', size: 'small' as const },
  { icon: Zap, title: 'Performance First', desc: 'Glass blur reduced on mobile. Animations respect prefers-reduced-motion. Every effect is earned, never decorative.', size: 'large' as const },
  { icon: Globe, title: 'Universal Access', desc: 'WCAG focus states, high contrast, safe-area insets, 44px touch targets.', size: 'small' as const },
  { icon: Code2, title: 'Developer Joy', desc: 'CVA variants, Tailwind utilities, typed animation exports. Build with it.', size: 'small' as const },
]

const processSteps = [
  { num: '01', title: 'Mythology as Specification', desc: 'Colors from elements. Timings from frequencies. The lore IS the design system.', color: 'arcane-crystal', icon: Gem },
  { num: '02', title: 'AI-Augmented Design', desc: 'Claude Code agents generate components, test variants, iterate patterns.', color: 'arcane-void', icon: Brain },
  { num: '03', title: 'Build in Public', desc: 'Every evolution stage documented, versioned, shared. Watch it grow.', color: 'arcane-fire', icon: Eye },
  { num: '04', title: 'Performance Budgets', desc: 'Glass blur costs CPU. Animations cost GPU. We budget every visual.', color: 'arcane-gold', icon: Zap },
  { num: '05', title: 'Continuous Evolution', desc: 'Never done. It evolves with the platform, mythology, and community.', color: 'arcane-water', icon: Star },
]
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                >
                  A living design language born from cosmic mythology.
                  Follow every decision from first pixel to full platform —
                  documented, versioned, open.
                </motion.p>
            ...
            >
              {[
                ...
                >
                  ...
                  <div className="text-[11px] font-sans text-text-muted uppercase tracking-wider">{stat.label}</div>
                </motion.div>
              ))}
            </motion.div>
          </div>
        ...
        >
          <div className="max-w-6xl mx-auto">
            <motion.div variants={cosmicFadeIn} className="text-center mb-12">
              <Badge variant="void" className="mb-4 font-sans text-xs tracking-[0.15em] px-3 py-1">
                PHILOSOPHY
              </Badge>
              ...
              <p className="text-fluid-base font-body text-text-secondary max-w-2xl mx-auto">
                Six principles guide every decision — from color to animation timing to accessibility.
              </p>
            </motion.div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-lg font-display text-white mb-2">{p.title}</h3>
                      <p className={cn(
        ...
        >
          <div className="max-w-6xl mx-auto">
            <motion.div variants={cosmicFadeIn} className="text-center mb-16">
              <Badge variant="gold" className="mb-4 font-sans text-xs tracking-[0.15em] px-3 py-1">
              ...
              <p className="text-fluid-base font-body text-text-secondary max-w-2xl mx-auto">
                Each stage documents a layer of the system. From foundational colors
                to the future of spatial computing.
              </p>
            </motion.div>
                        ...
                        <Link href={`/design-lab/${stage.id}`} className="group block">
                          ...
                          >
                            ...
                            <div className={cn(
                              ...
                              isLeft ? 'lg:flex-row-reverse lg:text-left' : '',
                            )}>
                              <div
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                  <span className="font-mono text-[11px] text-text-muted">{stage.id.toUpperCase()}</span>
                                  <span className="text-[9px] font-sans text-arcane-crystal/60 uppercase tracking-widest">{stage.element}</span>
                                </div>
                              ...
                              <ArrowRight className="w-4 h-4 text-text-disabled group-hover:text-arcane-crystal group-hover:translate-x-1 transition-all flex-shrink-0 mt-1" />
                            </div>
                          </motion.div>
                        </Link>
                      </div>
        ...
        >
          <div className="max-w-6xl mx-auto">
            <motion.div variants={cosmicFadeIn} className="mb-16">
              <Badge variant="fire" className="mb-4 font-sans text-xs tracking-[0.15em] px-3 py-1">
              ...
              <p className="text-fluid-base font-body text-text-secondary max-w-2xl leading-relaxed">
                Building Arcanea&apos;s design system is an act of world-building.
                Every token carries the mythology forward.
              </p>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-start gap-4">
                      <div
                        ...
                        style={{ backgroundColor: `var(--${step.color}, #7fffd4)10` }}
                      >
                        <span className={cn('text-sm font-mono', `text-${step.color}`)}>{step.num}</span>
                      </div>
                      <div>
                        <h3 className="text-base font-display text-white mb-1.5">{step.title}</h3>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="glass rounded-3xl p-6 sm:p-8 overflow-hidden">
              <div className="flex items-center gap-3 mb-6">
                <Palette className="w-5 h-5 text-arcane-crystal" />
                <h3 className="text-sm font-sans text-white tracking-wider uppercase">Live Palette</h3>
              </div>
              ...
              <div className="flex rounded-xl overflow-hidden mb-4 h-12 sm:h-16">
                {[
                  ...
                  <div key={c.label} className="flex-1 relative group cursor-crosshair" style={{ backgroundColor: c.color }}>
                    <div className="absolute inset-0 flex items-end justify-center pb-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <span className="text-[9px] font-mono text-white/60">{c.label}</span>
                    </div>
                  </div>
                ))}
              </div>
                ...
                {[
                  ...
                  <div key={c.label} className="flex-1 relative group cursor-crosshair" style={{ backgroundColor: c.color }}>
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <span className="text-[9px] font-mono text-cosmic-void font-bold">{c.label}</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-4 flex items-center justify-between">
                <span className="text-xs font-mono text-text-muted">6 cosmic layers + 7 elemental accents</span>
                <Link href="/design-lab/v1" className="text-xs font-sans text-arcane-crystal hover:text-arcane-crystal/80 transition-colors flex items-center gap-1">
                  Explore tokens <ArrowRight className="w-3 h-3" />
                </Link>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-fluid-base font-body text-text-secondary max-w-xl mx-auto mb-10">
                  Dive into ten stages of design evolution. Every color has meaning.
                  Every animation has purpose. Every component carries mythology.
                </p>
