            ...
            <div className="p-4 space-y-3 bg-cosmic-deep min-h-[300px]">
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg bg-arcane-crystal/20 flex items-center justify-center">
                  <Sparkles className="w-4 h-4 text-arcane-crystal" />
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <Moon className={`w-5 h-5 ${showReducedMotion ? 'text-arcane-crystal' : 'text-text-muted'}`} />
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <Sun className={`w-5 h-5 ${showHighContrast ? 'text-arcane-gold' : 'text-text-muted'}`} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <motion.div variants={cosmicFadeIn} className="glow-card rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <Move className="w-5 h-5 text-arcane-crystal" />
...
.bottom-bar {
  padding-bottom: calc(
    1rem + env(safe-area-inset-bottom)
          ...
          <motion.div variants={cosmicFadeIn} className="glow-card rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <Scroll className="w-5 h-5 text-arcane-crystal" />
