  ...
  return (
    <div className="glass rounded-2xl p-6 sm:p-8 space-y-6">
      <div className="flex items-center gap-3 mb-2">
        <MousePointer2 className="w-5 h-5 text-arcane-crystal" />
      ...
      <div className="flex flex-wrap gap-4">
        ...
        >
          <Zap className="w-3.5 h-3.5" /> Icon
        </button>
        <button
      ...
      <div className="bg-cosmic-void/50 rounded-2xl p-8 flex flex-col items-center justify-center gap-6 min-h-[160px] border border-white/5">
        <div className="flex items-center gap-3">
          ...
          >
            {withIcon && <Sparkles className="w-4 h-4 mr-2" />}
            Arcanea Button
          </Button>
        </div>
    ...
    <div className="space-y-20 pb-20">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-arcane-crystal/10 flex items-center justify-center">
              <MousePointer2 className="w-4 h-4 text-arcane-crystal" />
            </div>
            <div>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-arcane-water/10 flex items-center justify-center">
              <Layers className="w-4 h-4 text-arcane-water" />
            </div>
            <div>
          ...
          <div className="glass rounded-2xl p-8 space-y-6">
              ...
              {buttonSizes.map(({ size, label, desc }) => (
                <div key={size} className="text-center space-y-2">
                  <Button variant="crystal" size={size}>
                    {size === 'icon' ? <Star className="w-4 h-4" /> : label}
                  </Button>
            ...
            <div className="border-t border-white/5 pt-6">
              ...
              <div className="flex flex-wrap items-end gap-4">
                <Button size="sm"><Send className="w-3 h-3 mr-1.5" />Send</Button>
                <Button size="default" variant="crystal"><Heart className="w-4 h-4 mr-2" />Favorite</Button>
                <Button size="lg" variant="fire"><Zap className="w-4 h-4 mr-2" />Power Up</Button>
                <Button size="xl" variant="gold"><Crown className="w-5 h-5 mr-2" />Ascend</Button>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="water" className="font-sans text-xs">
                  <Droplets className="w-3 h-3 mr-1" />Atlantean
                </Badge>
      ...
      <motion.section {...fadeInViewport} variants={scrollReveal}>
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-arcane-water/10 flex items-center justify-center">
              <Search className="w-4 h-4 text-arcane-water" />
            </div>
            <div>
