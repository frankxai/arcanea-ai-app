...
export const SKILLS: Skill[] = [
  ...
  { id: 'source-light', name: 'Source Illumination', command: '/skill source-illum', element: 'void', powerLevel: 10, description: 'Bring light to dark places', useCases: ['Shadow work', 'Recovery', 'Finding lost treasures'], cooldown: 30, gateRequirement: 5, guardians: ['Source-Illuminator'] },
