...
export const metadata: Metadata = {
  ...
  description: `Build on Arcanea — Credits API, an MCP server with ${FACTS.mcpTools} tools, ${FACTS.skills} creator skills, and open-source packages. Extend the intelligence layer with your own agents and integrations.`,
  openGraph: {
