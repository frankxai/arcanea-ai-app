...
export const alt =
  "Arcanea Developer Documentation — Credits API, MCP Servers, 20 Creator Skills, Open Source";
...
export default function OGImage() {
  return createOGImage({
    ...
    subtitle:
      "Credits API \u00b7 MCP Servers \u00b7 20 Creator Skills \u00b7 Open Source",
