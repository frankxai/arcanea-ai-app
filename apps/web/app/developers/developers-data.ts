...
export const TOOLS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "MCP Server", description: `${FACTS.mcpTools} tools with skill-rules` },
    ],
    color: "var(--arc-brand-atlantean-teal)",
  },
];
...
export const MCP_SERVERS = [
  {
    name: "arcanea-mcp",
    description:
      `The core MCP server with ${FACTS.mcpTools} tools: world-building, canon validation, Luminor companions, story generation, agent orchestration.`,
...
export const OPEN_SOURCE_REPOS = [
  {
    ...
    description:
      `Main monorepo. Web app, intelligence packages, MCP servers, creative pipeline, and ${PUBLIC_REPO_SUMMARY.packages} npm packages.`,
    href: "https://github.com/frankxai/arcanea",
    color: "var(--arc-brand-atlantean-teal)",
  },
  {
