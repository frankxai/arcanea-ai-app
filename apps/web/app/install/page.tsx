...
const PATHS: PathOption[] = [
  {
    ...
    steps: [
      {
        label: "Visit arcanea.ai",
        detail: "Open the platform in your browser",
      },
      {
        label: "Create an account",
        detail: "Sign up with email or social login",
      },
      {
        label: "Choose a companion",
        detail: "Select an AI partner matched to your creative style",
      },
      {
        label: "Start creating",
        detail: "Chat, imagine, write, compose — the universe is yours",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        detail: "Choose your preferred package manager",
        code: "npm install -g arcanea-ai",
      },
      {
        label: "Authenticate",
        detail: "Sign in with your Arcanea account",
        code: "arcanea login",
      },
      {
        label: "Start a session",
        detail: "Launch a companion session from terminal",
        code: "arcanea chat --companion architect",
      },
      {
        label: "Explore commands",
        detail: "View all available tools",
        code: "arcanea --help",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        detail: "Clone the Arcanea framework to your GitHub",
        code: "git clone https://github.com/frankxai/arcanea.git",
      },
      {
        label: "Install dependencies",
        detail: "Set up the development environment",
        code: "cd arcanea && pnpm install",
      },
      {
        label: "Configure environment",
        detail: "Copy the env template and add your keys",
...
const REQUIREMENTS: Requirement[] = [
  ...
  { name: "Git", version: "2.30+", note: "For framework fork path" },
  {
    name: "Supabase",
    version: "Latest",
    note: "For self-hosted database (optional)",
  },
];
...
const NEXT_STEPS: NextStep[] = [
  ...
  {
    title: "Academy",
    description: "Learn world-building from Gate 1 to 10",
    href: "/academy",
    icon: GraduationCap,
  ...
  {
    title: "Chat",
    description: "Start a conversation with an AI companion",
    href: "/chat",
    icon: ChatCircle,
    accent: "text-[var(--arc-brand-cosmic-blue)]",
  },
  {
    title: "Ecosystem",
    description: "Explore all 14 public repositories and tools",
    href: "/ecosystem",
    icon: Gear,
    accent: "text-[var(--arc-brand-arcanean-gold)]",
  },
...
function PathCard({ path, index }: { path: PathOption; index: number }) {
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-gradient-to-b ${path.gradient} pointer-events-none`}
      />
      ...
      <div className="relative p-7">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className={`text-xs font-mono ${path.accent} opacity-70`}>
              {path.subtitle}
            </p>
          </div>
        </div>
          ...
          <section className="mb-16">
            ...
            >
              ...
              <p className="text-lg text-white/50 leading-relaxed max-w-2xl mx-auto">
                Three paths into the Arcanea ecosystem. Use the platform
                directly, install the CLI for terminal access, or fork the
                entire framework to build your own universe.
              </p>
            </m.div>
          </section>
            ...
            <div className="rounded-2xl overflow-hidden border border-white/[0.06]">
              ...
              <div className="p-6 bg-black/40 font-mono text-sm space-y-1.5">
                ...
                <p>
                  ...
                  <span className="text-amber-400/60">your-project-url</span>
                </p>
                <p>
                  <span className="text-[var(--arc-brand-atlantean-teal)]/60">
                  ...
                  <span className="text-white/20">=</span>
                  <span className="text-amber-400/60">your-anon-key</span>
                </p>
                ...
                <p>
                  ...
                  <span className="text-white/20">=</span>
                  <span className="text-amber-400/60">your-gemini-key</span>
                </p>
                <p>
                  <span className="text-[var(--arc-brand-atlantean-teal)]/60">
                    ANTHROPIC_API_KEY
                  ...
                  <span className="text-white/20">=</span>
                  <span className="text-amber-400/60">your-claude-key</span>
                </p>
