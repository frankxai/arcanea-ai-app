      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="pt-20 pb-16 lg:pt-28 lg:pb-20">
          <div className="relative liquid-glass rounded-3xl overflow-hidden px-8 py-16 sm:px-12 sm:py-20">
            <div className="animate-pulse space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/[0.06] bg-white/[0.04] w-44 h-8" />
              <div className="h-14 bg-white/[0.06] rounded-lg w-3/4" />
              <div className="h-6 bg-white/[0.06] rounded-lg w-1/2" />
              <div className="flex gap-4 mt-8">
                <div className="h-12 bg-white/[0.06] rounded-xl w-36" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="liquid-glass rounded-xl p-4 animate-pulse">
                ...
                <div className="h-6 bg-white/[0.06] rounded w-12 mx-auto" />
                <div className="h-3 bg-white/[0.06] rounded w-24 mx-auto mt-2" />
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="py-12 border-t border-white/[0.04]">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="card-3d liquid-glass rounded-2xl p-6 animate-pulse">
                <div className="w-12 h-12 bg-white/[0.06] rounded-xl mx-auto mb-4" />
                <div className="h-5 bg-white/[0.06] rounded w-24 mx-auto mb-2" />
        ...
        {/* CTA Skeleton */}
        <section className="py-16 border-t border-white/[0.04] pb-24">
          <div className="liquid-glass rounded-3xl overflow-hidden p-10 sm:p-14">
            <div className="animate-pulse text-center mx-auto max-w-xl">
              ...
              <div className="h-12 bg-white/[0.06] rounded-xl w-44 mx-auto" />
            </div>
          </div>
        </section>
      </main>
