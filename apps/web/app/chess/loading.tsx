    ...
    <div className="relative min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="liquid-glass rounded-xl p-5 animate-pulse">
              <div className="h-10 w-10 bg-white/[0.06] rounded-lg mb-3" />
              <div className="h-5 bg-white/[0.06] rounded w-1/2 mb-2" />
        ...
        <div className="card-3d liquid-glass rounded-2xl p-6">
          <div className="h-6 bg-white/[0.06] rounded w-40 mb-6" />
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
