...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/imagination-charter`,
      lastModified: new Date(),
    ...
    {
      url: `${baseUrl}/lore/guardians`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/lore/gates`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/lore/elements`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/lore/godbeasts`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/lore/wisdoms`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/lore/malachar`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.75,
    },
    {
      url: `${baseUrl}/lore/library`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.75,
    },
    ...
    {
      url: `${baseUrl}/academy/certification`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/academy/gate-quiz`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.75,
    },
    ...
    // ── Living Lore ────────────────────────────────────────
    {
      url: `${baseUrl}/living-lore`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/living-lore/crew`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/living-lore/chronicle`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/living-lore/journal`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
      url: `${baseUrl}/living-lore/gallery`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
      url: `${baseUrl}/living-lore/book`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/living-lore/encounter`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.75,
    },
  ...
  const constellationPages: MetadataRoute.Sitemap =
    constellationData.agents.map((agent) => ({
      url: `${baseUrl}/constellation/${agent.id}`,
      lastModified: new Date(constellationData.meta.generatedAt),
      changeFrequency: "monthly" as const,
      priority: 0.78,
    }));
  const characterIdentityPages: MetadataRoute.Sitemap =
  ...
  const guardianIdentityPages: MetadataRoute.Sitemap =
  ...
  const godbeastIdentityPages: MetadataRoute.Sitemap =
    godbeastData.godbeasts.map((godbeast) => ({
      url: `${baseUrl}/constellation/godbeasts/${godbeast.id}`,
      lastModified: new Date(godbeastData.meta.generatedAt),
      changeFrequency: "monthly" as const,
      priority: 0.76,
    }));
  const worldIdentityPages: MetadataRoute.Sitemap = worldData.worlds.map(
    (world) => ({
  ...
  const promptContractPages: MetadataRoute.Sitemap =
    campaignData.rounds.flatMap((round) =>
      round.jobs.map((job) => ({
  ...
  const libraryCollectionPages: MetadataRoute.Sitemap = COLLECTIONS.map(
    (c) => ({
