...
export const HERO_STATS = [
  { value: "6",   label: "Protocol layers", color: "#7fffd4" },
  { value: "MIT", label: "Licensed",         color: "#00bcd4" },
  { value: "3",   label: "Reference impls",  color: "#c084fc" },
  { value: "EIP", label: "Compatible",       color: "#ffd700" },
] as const;
...
export const STATUS_PILL: Record<SpecStatus, { label: string; bg: string; color: string; border: string }> = {
  stable: { label: "Stable",    bg: "rgba(0,188,212,0.09)",  color: "#7fffd4", border: "rgba(127,255,212,0.22)" },
  draft:  { label: "Draft",     bg: "rgba(0,188,212,0.07)",  color: "#00bcd4", border: "rgba(0,188,212,0.22)"   },
  review: { label: "In review", bg: "rgba(251,191,36,0.08)", color: "#fbbf24", border: "rgba(251,191,36,0.22)"  },
};
