...
const PAGES = [
  ...
  },
  {
    ...
    description:
      "Commitments for human authorship, provenance, and participatory worldbuilding",
  ...
  },
  {
    title: "Story",
    description:
      "The First Light — Lumina and Nero, origin of the Arcanea universe",
    internalPath: "/story",
  },
  {
    title: "Library",
  ...
  },
  {
    ...
    description:
      "Public-safe agent blueprints, identity dossiers, and visual campaign contracts",
  ...
  },
  {
    title: "Agents",
    description:
      "HTML product hub for Luminors; machine-readable orientation is /agents.md",
    internalPath: "/agents",
  },
  {
    title: "Pricing",
