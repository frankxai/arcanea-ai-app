...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "The public Library and the Arcanea World MCP server are free today. Nothing on arcanea.ai is on sale yet: Arcanea and Arcanea MCP Studio have waitlists on the pricing page, and a price is published only when a product is finished and tested.",
  },
  {
