...
const GATES = [
  ...
  },
  {
    ...
    metaphysical: 'The fifth Gate vibrates at 528 Hz — the miracle frequency, the frequency of DNA repair and transformation. This is the Gate where inner truth becomes outer reality. Everything you speak becomes a spell — a shaping force that bends the world toward or away from your vision. Alera guards this Gate because truth requires a keeper. Not all truths should be spoken. But the truths that matter must be.',
  ...
  },
  {
    ...
    metaphysical: 'The seventh Gate burns at 741 Hz — the frequency of awakening intuition and dissolving illusion. Here, the journey turns. The lower six Gates built the creator. The Crown Gate begins to dissolve them. Not destruction — refinement. Aiyami teaches that mastery is not the accumulation of knowledge but the courage to release what is no longer true. Every false belief you carry weighs down your creative flight.',
