...
const GATES = [
  ...
  },
  {
    ...
    metaphysical: 'The fifth Gate vibrates at the miracle frequency, the frequency of DNA repair and transformation. This is the Gate where inner truth becomes outer reality. Everything you speak becomes a spell — a shaping force that bends the world toward or away from your vision. Alera guards this Gate because truth requires a keeper. Not all truths should be spoken. But the truths that matter must be.',
  ...
  },
  {
    ...
    metaphysical: 'The sixth Gate hums with the frequency of connection and relationship, of patterns too large for the conscious mind to hold. Lyria sees what is becoming, not merely what is. She reads the currents beneath the surface, the intentions behind the words, the trajectory of things not yet arrived. This Gate opens when the creator stops looking and begins seeing.',
  ...
  },
  {
    ...
    metaphysical: 'The seventh Gate burns with the frequency of awakening intuition and solving problems. Here, the journey turns. The lower six Gates built the creator. The Crown Gate begins to dissolve them. Not destruction — refinement. Aiyami teaches that mastery is not the accumulation of knowledge but the courage to release what is no longer true. Every false belief you carry weighs down your creative flight.',
  ...
  },
  {
    ...
    metaphysical: 'The ninth Gate resonates with the frequency of the pineal gland, the connection to higher consciousness. Ino guards the penultimate Gate because unity is the last lesson before Source. The lone creator can open eight Gates. The ninth requires another. Not dependence — sacred partnership, where two consciousnesses amplify each other beyond what either could reach alone. This is the Gate that teaches: you were never meant to do this alone.',
  ...
  },
  {
    ...
    metaphysical: 'The tenth Gate sings at a frequency beyond the Solfeggio scale, the meta-frequency that contains all others. Shinkami is the only Guardian to have fully merged with their Godbeast. At the Source Gate, the distinction between creator and creation dissolves. You do not pass through this Gate. You realize you have always been standing on the other side of it, looking back at yourself. The journey through the Ten Gates was never a climb upward. It was a remembering inward.',
