...
// Catalog metadata belongs to this route, not to every book and chapter below it.
export const metadata: Metadata = {
  title: "Books | Arcanea",
  description: "Explore Arcanea’s stories, series and reading previews.",
  ...
  const enrichedBooks = CHRONICLE_BOOKS.map((cb) => {
    ...
    if (real && real.wordCount > 0) {
      return {
        ...
        chapterCount:
          real.chapterCount > 0 ? real.chapterCount : cb.chapterCount,
      };
    }
    return cb;
  });
  ...
  return (
    <div className="relative min-h-screen bg-[var(--arc-cosmic-void)] text-white">
      ...
      <section className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden px-6 py-24">
        <div
          className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[var(--arc-cosmic-void)] via-[var(--arc-cosmic-void)] to-[var(--arc-cosmic-void)]"
          aria-hidden="true"
        />
        <div
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <p className="mb-6 font-mono text-[11px] uppercase tracking-[0.35em] text-[var(--arc-brand-atlantean-teal)]/70">
          ...
          <div
            className="mx-auto mt-10 flex w-48 items-center gap-3 text-[var(--arc-brand-atlantean-teal)]/20"
            aria-hidden="true"
          >
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              href="#chronicles"
              className="inline-flex items-center gap-2 rounded-full border border-[var(--arc-brand-atlantean-teal)]/30 bg-[var(--arc-brand-atlantean-teal)]/10 px-8 py-3.5 text-sm font-semibold text-[var(--arc-brand-atlantean-teal)] transition-all hover:border-[var(--arc-brand-atlantean-teal)]/50 hover:bg-[var(--arc-brand-atlantean-teal)]/18 hover:shadow-[0_0_32px_rgba(0,188,212,0.15)]"
            >
              Begin Reading
              <svg
                className="h-4 w-4"
      ...
      >
        <div className="mb-16 text-center">
          <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.3em] text-[var(--arc-brand-atlantean-teal)]/70">
            Main Series
          </p>
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/65">
            A ten-book epic following Kael and the Five-Fold Five as they
            navigate the politics, magic, and ancient darkness of the Arcanean
            world.
          </p>
        </div>
        ...
        >
          <div className="mb-16 flex items-center gap-4" aria-hidden="true">
            ...
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/65">
                Beyond the Chronicles, the world keeps expanding. Crews,
                dragon-riders, Dungeon divers, Gate-Touched survivors, and the
                voices of those the main story calls enemies.
              </p>
            </div>
            <span className="h-px flex-1 bg-white/6" />
          </div>
      ...
      <section className="relative overflow-hidden py-24">
        <div
          className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-[var(--arc-brand-atlantean-teal)]/[0.03] to-transparent"
          aria-hidden="true"
        />
          ...
          <div className="space-y-16">
            {FEATURED_PASSAGES.map((passage, i) => (
              <blockquote key={i} className="group relative pl-6">
                <div
                  className="absolute left-0 top-0 h-full w-px bg-gradient-to-b from-[var(--arc-brand-atlantean-teal)]/40 via-[var(--arc-brand-atlantean-teal)]/20 to-transparent"
                  aria-hidden="true"
                />
                ...
                <footer className="mt-5 flex items-center justify-between gap-4">
                  ...
                  <Link
                    href={passage.href}
                    className="shrink-0 rounded-full border border-[var(--arc-brand-atlantean-teal)]/30 px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.15em] text-[var(--arc-brand-atlantean-teal)]/70 transition-all hover:border-[var(--arc-brand-atlantean-teal)]/50 hover:text-[var(--arc-brand-atlantean-teal)]"
                  >
                    Read chapter
                  </Link>
                </footer>
      ...
      <section className="mx-auto max-w-5xl px-6 py-24">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-white/65">
            Every gate into the world is the right one. Follow the thread that
            calls to you.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {READING_PATHS.map((path) => (
            <Link
              key={path.href}
              href={path.href}
              className="group relative overflow-hidden rounded-xl border border-white/8 bg-white/[0.02] p-6 transition-all hover:border-[var(--arc-brand-atlantean-teal)]/25 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(0,188,212,0.06)]"
            >
              <span
                className="mb-4 block font-mono text-2xl text-[var(--arc-brand-atlantean-teal)]/40 transition-colors group-hover:text-[var(--arc-brand-atlantean-teal)]/70"
                aria-hidden="true"
              >
                {path.icon}
              </span>
              ...
              <svg
                className="absolute right-5 top-5 h-4 w-4 text-white/15 transition-all group-hover:translate-x-0.5 group-hover:text-[var(--arc-brand-atlantean-teal)]/40"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={1.5}
      ...
      <section className="relative mx-auto max-w-6xl px-6 py-24">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-white/65">
            Three institutions, three philosophies, one fracture running through
            all of them.
          </p>
        </div>
          ...
          {ACADEMIES.map((academy) => (
            ...
            >
              ...
              <div className="relative z-10">
                <span
                  className={`mb-5 block font-mono text-3xl ${academy.textAccent}/60`}
                  aria-hidden="true"
                >
                  {academy.symbol}
                </span>
                ...
                <p
                  className={`mt-0.5 font-mono text-[10px] uppercase tracking-[0.2em] ${academy.textAccent}/50`}
                >
                  {academy.location}
                </p>
                <p
                  className={`mt-1 text-xs font-medium ${academy.textAccent}/60`}
                >
                  {academy.element}
                </p>
                <blockquote className="mt-5 border-l border-white/10 pl-3">
                  <p className="text-xs leading-relaxed italic text-white/65">
                    {academy.philosophy}
                  </p>
                </blockquote>
              </div>
      ...
      <section className="mx-auto max-w-5xl px-6 py-24">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-white/65">
            Everything that exists beyond the novels. The bones of the world
            made visible.
          </p>
        </div>
          ...
          {REFERENCE_DOCS.map((doc) => (
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <svg
                  className="h-3.5 w-3.5 text-white/20 transition-all group-hover:translate-x-0.5 group-hover:text-[var(--arc-brand-atlantean-teal)]/50"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
      ...
      <section className="relative overflow-hidden py-32">
        ...
        <div className="relative mx-auto max-w-2xl px-6 text-center">
          <span
            className="mb-6 block font-mono text-4xl text-[var(--arc-brand-atlantean-teal)]/30"
            aria-hidden="true"
          >
            &#9672;
          </span>
          ...
          <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-white/65 md:text-lg">
            Every element, every Academy, every Gate — they all begin with a
            single story about a lighthouse keeper who watched a strange storm.
          </p>
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/books/book1/chapter-01-the-first-spark"
              className="inline-flex items-center gap-2 rounded-full border border-[var(--arc-brand-atlantean-teal)]/30 bg-[var(--arc-brand-atlantean-teal)]/10 px-8 py-4 text-sm font-semibold text-[var(--arc-brand-atlantean-teal)] transition-all hover:border-[var(--arc-brand-atlantean-teal)]/50 hover:bg-[var(--arc-brand-atlantean-teal)]/18 hover:shadow-[0_0_40px_rgba(0,188,212,0.18)]"
            >
              Read Chapter One
              <svg
                className="h-4 w-4"
          ...
          <p className="mt-12 font-mono text-[11px] uppercase tracking-[0.3em] text-white/50">
            Enter seeking &nbsp;&middot;&nbsp; Leave transformed
            &nbsp;&middot;&nbsp; Return whenever needed
          </p>
        </div>
      </section>
    </div>
