    ...
    <div className="relative min-h-screen bg-[var(--arc-cosmic-void)] text-white">
      ...
      <section id="chronicles" className="relative mx-auto max-w-6xl px-6 py-24">
        <div className="mb-16 text-center">
          <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.3em] text-[var(--arc-brand-atlantean-teal)]/70">Main Series</p>
        ...
        <section id="multiverse" className="relative mx-auto max-w-6xl px-6 py-24">
          <div className="mb-16 flex items-center gap-4" aria-hidden="true">
            ...
            <div className="text-center">
              <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.3em] text-[var(--arc-brand-atlantean-teal)]/70">Expanded Universe</p>
      ...
      <section className="relative overflow-hidden py-32">
        ...
        <div className="relative mx-auto max-w-2xl px-6 text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link href="/books/book1/chapter-01-the-first-spark" className="inline-flex items-center gap-2 rounded-full border border-[var(--arc-brand-atlantean-teal)]/30 bg-[var(--arc-brand-atlantean-teal)]/10 px-8 py-4 text-sm font-semibold text-[var(--arc-brand-atlantean-teal)] transition-all hover:border-[var(--arc-brand-atlantean-teal)]/50 hover:bg-[var(--arc-brand-atlantean-teal)]/18 hover:shadow-[0_0_40px_rgba(0,188,212,0.18)]">
              Read Chapter One
