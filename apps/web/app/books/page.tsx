  ...
  return (
    <div className="relative min-h-screen bg-[var(--arc-cosmic-void)] text-white">
        ...
        <section id="multiverse" className="relative mx-auto max-w-6xl px-6 py-24">
          <div className="mb-16 flex items-center gap-4" aria-hidden="true">
            ...
            <div className="text-center">
              <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.3em] text-[var(--arc-brand-atlantean-teal)]/70">Development Library</p>
              <h2 className="font-display text-3xl font-bold tracking-tight text-white/90 md:text-4xl">Other Arcanea Story Lines</h2>
              <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/65">
                These are development continuities, not a promise that every listed series is complete, canon-locked, or scheduled for release.
              </p>
            </div>
            <span className="h-px flex-1 bg-white/6" />
          </div>
      ...
      <section className="relative overflow-hidden py-24">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-[var(--arc-brand-atlantean-teal)]/[0.03] to-transparent" aria-hidden="true" />
        <div className="relative mx-auto max-w-3xl px-6">
          <div className="mb-12 flex items-center gap-4">
            <span className="h-px flex-1 bg-white/8" aria-hidden="true" />
            <p className="font-mono text-[10px] uppercase tracking-[0.35em] text-white/50">From Development Drafts</p>
            <span className="h-px flex-1 bg-white/8" aria-hidden="true" />
          </div>
          ...
          <div className="space-y-16">
            {FEATURED_PASSAGES.map((passage, i) => (
              <blockquote key={i} className="group relative pl-6">
                <div className="absolute left-0 top-0 h-full w-px bg-gradient-to-b from-[var(--arc-brand-atlantean-teal)]/40 via-[var(--arc-brand-atlantean-teal)]/20 to-transparent" aria-hidden="true" />
                ...
                <footer className="mt-5 flex items-center justify-between gap-4">
                  ...
                  <Link href={passage.href} className="shrink-0 rounded-full border border-[var(--arc-brand-atlantean-teal)]/30 px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.15em] text-[var(--arc-brand-atlantean-teal)]/70 transition-all hover:border-[var(--arc-brand-atlantean-teal)]/50 hover:text-[var(--arc-brand-atlantean-teal)]">
                    Read chapter
                  </Link>
                </footer>
              </blockquote>
      ...
      <section className="mx-auto max-w-5xl px-6 py-24">
        <div className="mb-12 text-center">
          <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.3em] text-[var(--arc-brand-atlantean-teal)]/70">Deep Reference</p>
          <h2 className="font-display text-3xl font-bold tracking-tight text-white/90">The Reference Library</h2>
          <p className="mx-auto mt-3 max-w-md text-sm text-white/65">Reference inventory under review. Counts and availability are generated only when the deployed source can prove them.</p>
        </div>
          ...
          {REFERENCE_DOCS.map((doc) => (
            <Link key={doc.slug} href={`/books/docs/${doc.slug}`} className="group flex flex-col rounded-xl border border-white/7 bg-white/[0.02] p-5 transition-all hover:border-white/14 hover:bg-white/[0.04]">
              <div className="mb-3 flex items-start justify-between gap-2">
                ...
                <span className="font-mono text-[10px] text-white/20">{doc.readTime}</span>
              </div>
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <svg className="h-3.5 w-3.5 text-white/20 transition-all group-hover:translate-x-0.5 group-hover:text-[var(--arc-brand-atlantean-teal)]/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
              </div>
            </Link>
