...
import { loadSeleneYBrioChapters } from "./selene-y-brio.data";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "An illustrated companion edition from the Selene & Brío series.",
...
export default async function SeleneYBrioPage() {
  ...
  const chapters = await loadSeleneYBrioChapters();
  return (
