...
export async function generateMetadata({
  ...
  return {
    title: `${gate.name} Gate | Academy`,
    description: `The ${gate.name} Gate. Guardian: ${gate.guardian}. Godbeast: ${gate.godbeast}. Element: ${gate.element}. ${gate.description}`,
    openGraph: {
      title: `${gate.name} Gate | Academy`,
    ...
    <div className="mb-8 grid gap-6 md:grid-cols-2">
      <div className="rounded-2xl liquid-glass border border-white/[0.06] p-7">
        ...
        <p className="text-sm text-text-secondary leading-relaxed">
          {gate.guardian} is the keeper of the {gate.name} Gate. As Guardian, {gate.guardian} guides creators through the domain of{' '}
