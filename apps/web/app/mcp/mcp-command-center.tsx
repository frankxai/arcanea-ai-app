...
const PLATFORMS = [
  {
    ...
    description: "One command installs 54 worldbuilding tools into any Claude Code session.",
  },
  {
    name: "Claude Desktop",
  ...
  "mcpServers": {
    ...
    description: "Add to your Claude Desktop config to enable Arcanea tools in every chat.",
  },
  {
    name: "Cursor",
  ...
  "arcanea": {
    ...
    description: "Add to Cursor MCP config for worldbuilding tools in Composer and Chat.",
  },
];
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-white/55 max-w-2xl mx-auto leading-relaxed">
              54 worldbuilding tools for Claude, ChatGPT, and Cursor. One command to install.
            </p>
          </div>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <div className="flex items-start gap-3">
                <div className="shrink-0 w-6 h-6 rounded-lg bg-[var(--arc-brand-atlantean-teal)]/10 border border-[var(--arc-brand-atlantean-teal)]/30 flex items-center justify-center">
                  <span className="text-xs font-display font-bold text-[var(--arc-brand-atlantean-teal)]">54</span>
                </div>
                <div>
              ...
              <div className="flex items-start gap-3">
                <div className="shrink-0 w-6 h-6 rounded-lg bg-[var(--arc-brand-arcanean-gold)]/10 border border-[var(--arc-brand-arcanean-gold)]/30 flex items-center justify-center">
                  <span className="text-xs font-display font-bold text-[var(--arc-brand-arcanean-gold)]">5</span>
                </div>
                <div>
                  <p className="text-sm font-medium text-white/80">Production recipes</p>
                  <p className="text-xs text-white/40">Book, game, music, cinema, campaign workflows</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/40">9 creative skills in the <a href="/skills" className="text-[var(--arc-brand-atlantean-teal)] hover:underline">open library</a></p>
                </div>
              </div>
            </div>
          </div>
