...
export default function ShowcaseError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-12 bg-[var(--arc-cosmic-void)]">
      ...
      <h2 className="mb-2 text-xl font-bold text-[var(--arc-brand-atlantean-teal)] font-display">Showcase unavailable</h2>
      <p className="mb-6 max-w-sm text-center text-sm text-white/50">Something went wrong. The creations are still there.</p>
