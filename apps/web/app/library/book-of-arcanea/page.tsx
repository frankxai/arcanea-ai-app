        ...
        <article className="book-prose">
          <ReactMarkdown
            components={{
              ...
              p: ({ children }) => (
                <p className="mb-6 text-lg leading-[1.85] text-white/70">
                  {children}
                </p>
              ),
              em: ({ children }) => (
                <em className="text-white/85 not-italic font-medium">
                  {children}
                </em>
              ),
              strong: ({ children }) => (
              ...
              hr: () => (
                <hr className="my-16 border-0 border-t border-white/[0.06]" />
              ),
              ul: ({ children }) => (
                <ul className="mb-6 space-y-2 pl-6 text-lg text-white/70">
                  {children}
                </ul>
              ),
              ol: ({ children }) => (
