...
export default function ChatPage() {
  ...
  const sendMessage = useCallback(async (content: string) => {
    ...
    const payload = {
      ...
      systemPrompt: 'You are Arcanea, a powerful and helpful AI assistant. Be direct, clear, and thorough. Use markdown for formatting when helpful. You can assist with writing, coding, analysis, creative work, and more.',
    };
