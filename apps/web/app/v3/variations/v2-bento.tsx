...
function ChatMockup() {
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        What would you like to create today? I can help with writing,
        brainstorming, or transforming your ideas.
      </div>
      <div
        className="rounded-xl px-4 py-3 text-sm self-end"
        style={{
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background: `radial-gradient(ellipse 60% 50% at 50% 0%, ${VIOLET}12 0%, transparent 70%)`,
            }}
          />
          <div className="relative z-10 mx-auto w-full max-w-6xl px-6 py-20 text-center md:py-28">
            ...
            >
              ...
              <span
                style={{
                  background: `linear-gradient(90deg, ${VIOLET}, ${TEAL}, ${GOLD})`,
                  ...
                  {GUARDIANS.map((g) => (
                    ...
                    >
                      <span
                        ...
                        style={{ backgroundColor: ELEMENT_COLORS[g.element] }}
                      />
                      {g.name}
                    </li>
                  ))}
                  ...
                  {[
                    ...
                    >
                      <div
                        ...
                        style={{
                          background: `${ELEMENT_COLORS[name]}20`,
                          border: `1px solid ${ELEMENT_COLORS[name]}40`,
                        }}
                      >
                        <Icon
                          size={22}
            ...
            >
              ...
              >
                ...
                <p className="text-sm mt-1" style={{ color: MUTED }}>
                  Where the dreamer and the dream become one
                </p>
              </Cell>
            </m.div>
        ...
        <section className="mx-auto w-full max-w-6xl px-6 pb-32 text-center">
          ...
          >
            <a
              ...
              style={{
                background: `linear-gradient(135deg, ${VIOLET}, ${TEAL}, ${GOLD})`,
              }}
            >
              Build Your Universe
