        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-2.5 bg-[var(--arc-cosmic-void)] border-b border-white/[0.04]">
              ...
              <span className="text-[11px] text-[var(--arc-earth)] ml-3 font-medium">arcanea.ai/studio</span>
            </div>
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex items-center justify-between px-4 py-2.5 border-b border-white/[0.04]">
                  <div className="flex items-center gap-2 text-[13px]">
                    ...
                    <span className="text-[var(--arc-text-primary)] font-medium">Chat</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="flex items-center bg-white/[0.04] rounded-md px-2.5 py-1 gap-1.5">
                      ...
                      <span className="text-[11px] text-[var(--arc-earth)]">Search...</span>
                    </div>
                    <UserCircle weight="fill" className="w-6 h-6 text-[var(--arc-earth)]" />
                  </div>
                </div>
                ...
                <div className="flex flex-1">
                  ...
                  <div className="flex-[3] border-r border-white/[0.04] p-4 flex flex-col">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-[10px] text-[var(--arc-earth)] bg-white/[0.04] px-1.5 py-0.5 rounded">Gate of Fire</span>
                    </div>
                    ...
                    <div className="mt-3 flex items-center bg-white/[0.03] border border-white/[0.06] rounded-lg px-3 py-2">
                      <span className="text-[11px] text-[var(--arc-earth)]">Ask Draconia...</span>
                    </div>
                  </div>
                  ...
                  <div className="flex-[2] p-4 flex flex-col gap-4">
                    ...
                    <div className="bg-white/[0.02] border border-white/[0.04] rounded-lg p-3">
                      <div className="text-[11px] text-[var(--arc-earth)] uppercase tracking-wider mb-2 font-medium">Active Project</div>
                      <div className="text-[13px] font-medium">The Transformation Chronicle</div>
                      <div className="text-[11px] text-[var(--arc-earth)] mt-1">Chapter 3 &middot; 2,400 words</div>
                    </div>

                    {/* Library Quick Access */}
                    <div className="bg-white/[0.02] border border-white/[0.04] rounded-lg p-3">
                      <div className="text-[11px] text-[var(--arc-earth)] uppercase tracking-wider mb-2 font-medium">Library Quick Access</div>
                    ...
                    {/* Gate Progress */}
                    <div className="bg-white/[0.02] border border-white/[0.04] rounded-lg p-3">
                      <div className="text-[11px] text-[var(--arc-earth)] uppercase tracking-wider mb-2 font-medium">Gate Progress</div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-[20px] font-bold text-[var(--arc-void)]">{GATES_OPEN}</span>
                        <span className="text-[12px] text-[var(--arc-earth)]">/ {GATES_TOTAL} gates</span>
                      </div>
                      ...
                      <div className="text-[10px] text-[var(--arc-earth)] mt-1.5">Rank: Mage</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {VALUE_PROPS.map((prop) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-[var(--arc-void)]/10 flex items-center justify-center mb-4 group-hover:bg-[var(--arc-void)]/20 transition-colors">
                <prop.icon weight="fill" className="w-5 h-5 text-[var(--arc-void)]" />
              </div>
              <h3 className="text-[16px] font-semibold mb-2">{prop.title}</h3>
              <p className="text-[13px] text-[var(--arc-earth)] leading-relaxed">{prop.description}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="border-t border-white/[0.04] py-8 px-4">
        <div className="flex flex-wrap items-center justify-center gap-4 text-[13px] text-[var(--arc-earth)]">
          ...
          {TECH_STACK.map((tech) => (
            <span
              key={tech}
              className="text-[var(--arc-void)] font-medium"
            >
              {tech}
            </span>
          ))}
