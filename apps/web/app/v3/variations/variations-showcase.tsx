...
const VARIATIONS: Variation[] = [
  {
    ...
    desc: "Pure black. Giant type. Zero decoration. Inspired by Grok.",
    component: HeroVoid,
  },
  {
    id: "warm",
    name: "Warm Gradient",
    desc: "Soft gradients, rounded cards, playful energy. Inspired by TikTok/Canva.",
    component: HeroWarmGradient,
  },
  {
    id: "cinematic",
    name: "Cinematic Dark",
    desc: "Full-bleed imagery, dramatic lighting, movie poster. Inspired by Suno.",
    component: HeroCinematic,
  },
  {
    id: "swiss",
    name: "Swiss Grid",
    desc: "Ultra-precise grid, monochrome, typography-first. Inspired by Vercel.",
    component: HeroSwissGrid,
  },
  {
    id: "neon",
    name: "Neon Glass",
    desc: "Glowing borders, glass cards, cyberpunk energy. Inspired by gaming tools.",
    component: HeroNeonGlass,
  },
  {
    id: "organic",
    name: "Organic Natural",
    desc: "Warm tones, organic shapes, artisanal feel. Inspired by Notion/Calm.",
    component: HeroOrganic,
  },
  {
    id: "editorial",
    name: "Editorial Magazine",
    desc: "Split layout, oversized type, drop caps. Inspired by Bloomberg.",
    component: HeroEditorial,
  },
  {
    id: "bento",
    name: "Bento Grid",
    desc: "Multi-card layout, mixed heights, modern SaaS. Inspired by Apple.",
    component: HeroBento,
  },
  {
    id: "motion",
    name: "Motion Theater",
    desc: "Scroll-driven reveals, parallax, every pixel earned. Inspired by Framer.",
    component: HeroMotionTheater,
  },
  {
    id: "canvas",
    name: "Immersive Canvas",
    desc: "Image-first, orbiting tags, gallery exhibition. Inspired by Midjourney.",
    component: HeroImmersiveCanvas,
  },
];
...
const FULL_PAGE: Variation[] = [
  {
    id: "fp-cinematic",
    name: "Cinematic Film",
    desc: "Letterbox bars, film grain, 2.39:1 aspect. Inspired by Runway/Veo/Sora.",
    component: V1Cinematic,
  },
  {
    id: "fp-bento",
    name: "Bento Grid",
    desc: "4-column grid, glass cards, gateway stats. Inspired by Apple/Linear/Vercel.",
    component: V2Bento,
  },
  {
    id: "fp-scroll",
    name: "Scroll Storytelling",
    desc: "Chapter-based 300vh sections, word-by-word reveal. Inspired by Apple product pages.",
    component: V3ScrollStory,
  },
  {
    id: "fp-dashboard",
    name: "Dashboard Preview",
    desc: "Product mockup with perspective tilt, fake UI. Inspired by Notion/Figma/Canva.",
    component: V4Dashboard,
  },
  {
    id: "fp-gradient",
    name: "Gradient Mesh",
    desc: "Animated gradient blobs, vibrant colors, mix-blend-mode. Inspired by Stripe/Clerk.",
    component: V5GradientMesh,
  },
  {
    id: "fp-terminal",
    name: "Terminal / Hacker",
    desc: "Full terminal aesthetic, boot sequence, process list. Inspired by Warp/Cursor.",
    component: V6Terminal,
  },
  {
    id: "fp-gallery",
    name: "Gallery / Museum",
    desc: "Art exhibition, gold frames, book spines. Inspired by MOMA/Midjourney.",
    component: V7Gallery,
  },
  {
    id: "fp-social",
    name: "Social Feed",
    desc: "TikTok-style feed, engagement bars, trending sidebar. Inspired by TikTok/Threads.",
    component: V8Social,
  },
  {
    id: "fp-particles",
    name: "Particle Universe",
    desc: "80 CSS-only particles, orbital showcase, constellation lines. Inspired by Three.js/Cosmos.",
    component: V9Particles,
  },
  {
    id: "fp-minimal",
    name: "Minimal Zen",
    desc: "Maximum restraint, 186 lines, no icons. Inspired by Muji/Arc Browser.",
    component: V10Minimal,
  },
];
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <header className="relative mx-auto w-full max-w-6xl px-6 pb-16 pt-20 md:px-8 md:pt-28">
          ...
          >
            20 competing designs across 2 waves. Each a different philosophy.
            Scroll to explore, or jump directly.
          </m.p>
          ...
          <div className="mt-16 mb-4 flex items-center gap-3">
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, var(--arc-void), transparent)",
              }}
            />
            <span
              className="font-mono text-xs uppercase tracking-[0.3em]"
          ...
          <p
            ...
            style={{ color: "rgba(255,255,255,0.4)" }}
          >
            10 complete homepage builds from a competitive agent swarm. Each
            agent had a distinct design philosophy.
          </p>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {FULL_PAGE.map((v, i) => (
              <m.button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(139,92,246,0.05) 0%, rgba(139,92,246,0.01) 100%)",
                }}
                custom={i + 10}
                initial="hidden"
                animate="visible"
