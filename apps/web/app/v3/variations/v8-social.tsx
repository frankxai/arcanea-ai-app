...
const GUARDIANS = [
  { name: "Draconia", hz: 396 },
  { name: "Lyria", hz: 639 },
  { name: "Shinkami", hz: 1111 },
  { name: "Alera", hz: 528 },
  { name: "Maylinn", hz: 417 },
];
...
const CARDS: Array<{
...
}> = [
  {
    ...
    user: "Luna_creates",
    init: "LC",
    grad: `linear-gradient(135deg,${T.violet},${T.teal})`,
    time: "2h ago",
    tag: "Made with Draconia",
    hearts: "234",
    comments: "18",
  },
  {
    ...
    user: "cosmic_writer",
    init: "CW",
    grad: `linear-gradient(135deg,${T.gold},var(--arc-fire))`,
    time: "5h ago",
    hearts: "891",
    comments: "42",
  },
  {
    ...
    user: "dev_phoenix",
    init: "DP",
    grad: `linear-gradient(135deg,var(--arc-fire),${T.gold})`,
    time: "1d ago",
    tag: "Built with Gateway API",
    hearts: "156",
    comments: "23",
  },
  {
    ...
    user: "void_artist",
    init: "VA",
    grad: `linear-gradient(135deg,${T.teal},${T.violet})`,
    time: "3d ago",
    hearts: "1.2K",
    comments: "87",
  },
  ...
  if (id === "story")
    return (
      ...
      >
        <PencilSimple
          size={16}
          style={{ marginRight: 6, opacity: 0.5, verticalAlign: "text-bottom" }}
        />
        &ldquo;The dragon spoke in frequencies only the heart could hear. Its
        voice was fire — not the kind that burns, but the kind that forges. She
        understood then that every great work begins as raw heat, waiting to be
        shaped.&rdquo;
      </div>
    );
  if (id === "wisdom")
    return (
      <div
        style={{
          background:
            "linear-gradient(135deg,rgba(139,92,246,0.15),rgba(127,255,212,0.08))",
          borderRadius: 16,
          padding: "28px 24px",
        }}
      >
        <Quotes
          size={28}
          weight="fill"
          style={{ color: T.violet, opacity: 0.4, marginBottom: 8 }}
        />
        <p
          style={{
            fontFamily: T.display,
        ...
        <span style={{ fontFamily: T.crimson, fontSize: 13, color: T.muted }}>
          Laws of Arcanea, Text III
        </span>
      </div>
    );
  if (id === "api")
    ...
    <div style={{ minHeight: "100vh", background: T.bg, color: T.text }}>
      ...
      >
            ...
            >
              ...
              >
                {[
                  ...
                  return (
                    <span key={l as string} style={pill}>
                      <Icon size={14} />
                      {l as string}
                    </span>
                  );
          ...
          {CARDS.map((c) => (
            ...
            >
              ...
              >
                <button
                  onClick={() => toggle(c.id)}
                  style={{ ...engBtn, color: liked[c.id] ? T.red : T.dim }}
                >
                  <Heart size={20} weight={liked[c.id] ? "fill" : "regular"} />
                  {c.hearts}
                </button>
                <button style={{ ...engBtn, color: T.dim }}>
                  <ChatCircle size={20} />
                  {c.comments}
                </button>
                <button style={{ ...engBtn, color: T.dim, marginLeft: "auto" }}>
                  <Share size={20} />
                  Share
                </button>
              </div>
        ...
        >
          <div style={sideCard}>
            <h3 style={sideHead}>
              <TrendUp size={16} style={{ color: T.violet }} />
              Trending Guardians
            </h3>
            <ul
              style={{
            ...
            >
              {GUARDIANS.map((g, i) => (
                ...
                >
                  ...
                  <span
                    style={{ fontFamily: T.mono, fontSize: 11, color: T.dim }}
                  >
                    {g.hz} Hz
                  </span>
                  <Fire
          ...
          <div style={sideCard}>
            <h3 style={sideHead}>
              <BookOpen size={16} style={{ color: T.teal }} />
              ...
              {LIB_TEXTS.map((t) => (
                <li key={t}>
                  <a
                    ...
                    onMouseEnter={(e) => {
                      (e.target as HTMLElement).style.color = T.teal;
                    }}
                    onMouseLeave={(e) => {
