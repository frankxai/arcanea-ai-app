...
const GUARDIANS: {
  ...
  },
  {
    ...
    el: "Unity",
    hz: 963,
    c: "var(--arc-brand-atlantean-teal)",
    Icon: Lightning,
  },
  {
    name: "Shinkami",
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      setT(
        Math.max(
          0,
          Math.min(1, -r.top / (el.offsetHeight - window.innerHeight)),
        ),
      );
    };
...
function ScrollProgress() {
  ...
  return (
    <div
      ...
      style={{ width: 3, height: "100vh" }}
    >
      <div
        style={{
          width: "100%",
          height: `${p}%`,
          background: `linear-gradient(to bottom, ${A}, rgba(127,255,212,0.3))`,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: "100vh", maxWidth: 720, margin: "0 auto" }}
      >
            ...
            return (
              <p
                ...
                style={{
                  ...
                  color: li === 2 ? A : "var(--arc-text-primary)",
                }}
              >
                {spans}
              </p>
        ...
        <a
          ...
          style={{
            ...
            color: A,
            padding: "14px 40px",
            border: `1px solid rgba(127,255,212,${ctaOn ? 0.3 : 0})`,
            borderRadius: 8,
            background: `rgba(127,255,212,${ctaOn ? 0.05 : 0})`,
            opacity: ctaOn ? 1 : 0,
            transform: ctaOn ? "translateY(0)" : "translateY(12px)",
            transition: "all 0.6s ease",
            pointerEvents: ctaOn ? "auto" : "none",
          }}
        >
          Begin <ArrowRight size={16} weight="bold" />
        </a>
      </div>
    </section>
  );
...
const Div = () => (
  <div
    ...
    style={{
      height: 1,
      background:
        "linear-gradient(to right, transparent, rgba(127,255,212,0.15), transparent)",
      margin: "0 auto",
      maxWidth: 600,
    }}
  />
...
function ChapterGuardians() {
  ...
  return (
    <section
      ref={ref}
      style={{
        height: `${GUARDIANS.length * 20 + 100}vh`,
        position: "relative",
        background: "var(--arc-cosmic-void)",
      }}
    >
      <div
        className="sticky top-0 flex flex-col md:flex-row items-start md:items-center"
        style={{ height: "100vh", padding: "0 clamp(24px,6vw,80px)" }}
      >
          ...
          {GUARDIANS.map((g, i) => {
            ...
            return (
              ...
              >
                <g.Icon
                  size={act ? 24 : 18}
                  weight={act ? "fill" : "light"}
                  color={act ? g.c : "rgba(212,212,212,0.3)"}
                  style={{ transition: "all 0.4s ease", flexShrink: 0 }}
                />
                <span
                  style={{
                    fontFamily: "var(--font-display)",
                ...
                {act && (
                  <div
                    ...
                    style={{
                      ...
                      height: 40,
                      borderRadius: "50%",
                      background: `radial-gradient(circle, ${g.c}22, transparent 70%)`,
                      position: "absolute",
...
function ChapterLibrary() {
  ...
  const bookPos: {
    ...
    { top: "12%", left: "8%", d: 0, s: 28 },
    { top: "20%", right: "12%", d: 1.5, s: 22 },
    { bottom: "25%", left: "15%", d: 0.7, s: 24 },
    { top: "65%", right: "8%", d: 2, s: 20 },
          ...
          {bookPos.map((p, i) => (
            <div
              ...
              style={{
                ...
                right: p.right,
                bottom: p.bottom,
                animation: `v3Float 6s ease-in-out ${p.d}s infinite`,
                opacity: t > 0.1 ? 0.2 : 0,
        ...
        <div className="text-center relative z-10">
            ...
            {LIB_CATS.map((cat, i) => (
              <span
                ...
                style={{
                  ...
                  borderRadius: 20,
                  opacity: i < catVis ? 1 : 0,
                  transform: i < catVis ? "scale(1)" : "scale(0.8)",
          ...
          <p
            ...
            style={{
              ...
              maxWidth: 480,
              opacity: qVis ? 1 : 0,
              transform: qVis ? "translateY(0)" : "translateY(12px)",
              transition: "all 0.7s ease",
            }}
          >
            &ldquo;These books are not entertainment. They are equipment for
            living.&rdquo;
          </p>
        </div>
      </div>
      ...
      >
        <div className="w-full max-w-xl">
          ...
          >
            ...
            {TERM_LINES.map((l, i) => (
              <div
                ...
                style={{
                  color: lineColor(l),
                  opacity: i < vLines ? 1 : 0,
                  transform: i < vLines ? "translateX(0)" : "translateX(-8px)",
                  transition: "all 0.3s ease",
                  minHeight: l === "" ? "1em" : undefined,
                }}
              >
                {l}
              </div>
            ))}
            {vLines > TERM_LINES.length && (
              <div
                className="mt-2"
                style={{
          ...
          <div
            ...
            style={{
              opacity: showP ? 1 : 0,
              transform: showP ? "translateY(0)" : "translateY(8px)",
...
function ChapterCTA() {
  ...
  return (
    <section
      ...
      style={{ height: "100vh", background: "var(--arc-cosmic-void)" }}
    >
        ...
        {Array.from({ length: 12 }).map((_, i) => (
          <div
            ...
            style={{
              ...
              opacity: on ? 0.3 : 0,
              animation: on
                ? `v3Rise ${4 + (i % 3) * 2}s linear ${i * 0.4}s infinite`
                : "none",
            }}
          />
        ))}
      ...
      >
        ...
        <a
          href="/discover"
          className="group inline-flex items-center gap-2 mt-12"
          style={{
            fontFamily: "var(--font-display)",
            fontSize: 16,
            ...
            background: A,
            boxShadow:
              "0 0 30px rgba(127,255,212,0.15), 0 0 60px rgba(127,255,212,0.05)",
            transition: "all 0.3s ease",
          }}
        >
          Begin{" "}
