...
const GUARDIANS = [
  {
    ...
    hz: 174,
    gradient:
      "linear-gradient(160deg, var(--arc-cosmic-void) 0%, var(--arc-cosmic-void) 40%, var(--arc-earth) 100%)",
  },
  {
    name: "Leyla",
    element: "Water",
    hz: 285,
    gradient:
      "linear-gradient(160deg, var(--arc-brand-cosmic-blue) 0%, var(--arc-brand-cosmic-blue) 40%, var(--arc-cosmic-void) 100%)",
  },
  {
    name: "Draconia",
    element: "Fire",
    hz: 396,
    gradient:
      "linear-gradient(160deg, var(--arc-earth) 0%, var(--arc-earth) 40%, var(--arc-cosmic-void) 100%)",
  },
  {
    name: "Maylinn",
    element: "Heart",
  ...
  },
  {
    ...
    hz: 528,
    gradient:
      "linear-gradient(160deg, var(--arc-brand-cosmic-blue) 0%, var(--arc-brand-cosmic-blue) 40%, var(--arc-brand-cosmic-blue) 100%)",
  },
  {
    name: "Lyria",
    element: "Sight",
  ...
  },
  {
    ...
    hz: 741,
    gradient:
      "linear-gradient(160deg, var(--arc-earth) 0%, var(--arc-earth) 40%, var(--arc-earth) 100%)",
  },
  {
    name: "Elara",
    element: "Starweave",
  ...
  },
  {
    ...
    hz: 963,
    gradient:
      "linear-gradient(160deg, var(--arc-earth) 0%, var(--arc-brand-cosmic-blue) 40%, var(--arc-cosmic-void) 100%)",
  },
  {
    name: "Shinkami",
    element: "Source",
      ...
      <div style={{ backgroundColor: T.bg, color: T.text, minHeight: "100vh" }}>
        ...
        <section className="px-8 py-32 max-w-[1400px] mx-auto">
          <ExhibitTitle
            ...
            subtitle="Digital Mythology, 2026"
          />
