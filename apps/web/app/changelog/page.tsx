...
const CHANGES = [
  {
    ...
    description:
      "The complete Luminor intelligence system is now live. 10 specialized creative intelligences, each mastering their domain.",
    changes: [
      { type: "added", text: "10 Luminors across 4 teams" },
