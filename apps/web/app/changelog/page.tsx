...
const CHANGELOG: ChangelogEntry[] = [
  {
    date: "2026-04-04",
    version: "3.6.0",
    title: "World Engine v0.2 — Quest Gen, Factions, 42 MCP Tools",
    category: "feature",
    items: [
      "@arcanea/world-engine v0.2.0 — enriched location + creature generators with depth hooks",
      "Quest generation system with narrative arcs, rewards, and difficulty scaling",
      "Faction dynamics engine with allegiance, territory, and conflict modeling",
      "MCP Bridge REST API — all 42 MCP tools accessible via standard HTTP endpoints",
      "mcp-bridge refactored to use world-engine as single source of truth",
      "mcp-server v1.0.0 + arcanea-flow v0.1.0 prepared for npm publish",
      "Playwright smoke tests added for core routes",
    ],
  },
  {
    date: "2026-04-04",
    version: "3.5.0",
    title: "Arcanea Orchestrator — Shared Ops Intelligence",
    category: "infrastructure",
    items: [
      "Arcanea Orchestrator (AO) shared command system: status, digest, cleanup, handover, sync",
      "ao-init bootstrap scripts for bash and PowerShell — instant agent onboarding",
      "ao-sync with category-aware GitHub intelligence sync across repos",
      "Deploy lock protocol for coordinated Vercel deployments",
      "Comprehensive XLSX sitemap: 118 routes mapped across 4 sheets",
      "Archived 36 stale planning/ops documents",
      "CI fixes: smoke test command, e2e tag correction for Quality Gate",
    ],
  },
  {
    date: "2026-04-04",
    version: "3.4.1",
    title: "Library Hero, Pricing Showcase & Visual Polish",
    category: "design",
    items: [
      "Library page hero section with collection browsing",
      "Pricing showcase page with tier comparison",
      "Rebuilt world-engine + mcp-server dist artifacts for v0.2/v1.0",
      "Presence Layer architecture research — full GPU audit and API-first pipeline design",
    ],
  },
  {
    date: "2026-04-03",
    version: "3.4.0",
    title: "World Graph, Imagine Overhaul & Deploy Battle",
    category: "feature",
    items: [
      "World Graph complete: CharacterCard, WorldDashboard, ElementBadge, service layer, API routes",
      "Imagine page Grok-inspired overhaul — floating bottom input bar, featured templates, Speed/Quality toggles",
      "Provider fallback chain: OpenRouter → Grok → Gemini with cascading error handling",
      "Chat provider logos and improved model selector UX",
      "gray-matter ESM migration — all require() converted to import across 8 files",
      "Removed generateStaticParams from all pages + force-dynamic everywhere",
      "MCP Bridge initial REST endpoint for tool logic",
      "NFT Forge collection preview page + forge hub update",
    ],
  },
  {
    date: "2026-04-03",
    version: "3.3.1",
    title: "Deploy Crisis — Next.js 16.2.2 workStore Invariant",
    category: "fix",
    items: [
      "Diagnosed fatal Next.js 16.2.2 prerender crash (workStore invariant)",
      "Pinned Next.js 16.1.1 via pnpm override in root package.json",
      "Removed custom global-error.tsx causing prerender crashes",
      "Added VERCEL_FORCE_NO_BUILD_CACHE=1 to build environment",
      "ESLint pinned to 9.17.0 — 9.39 crashes with ajvOrig error on Node 20",
      "Standalone output mode + prerenderEarlyExit false experiments",
      "Production still live on last READY deploy while fix in progress",
    ],
  },
  {
    date: "2026-03-29",
