...
export const REVENUE_STREAMS: RevenueStream[] = [
  {
    ...
    bullets: [
      ...
      "AP2 signed payment mandates secure transaction rails",
      "Instant Stripe and x402 micro-payouts",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Agentic-income agents optimize price and predict churn",
      "Export your full subscriber list any time",
      "Auto-sync roles with Discord or Whop portals",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Metadata SVGs compile dynamically from creator stats",
      "Treasury managed via multi-agent Byzantine consensus",
    ],
    href: "/nft",
  ...
  },
  {
    ...
    status: "beta",
    bullets: [
      "Enforced via Agentic Payments Protocol (AP2)",
      "Payouts happen on-chain — no approval queue",
      "Audit trail: see every fork and what it earned",
      "Compatible with existing Ethereum L2 wallets",
    ],
    href: "/worlds",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Supports lightning and x402 pay-per-read streaming caps",
  ...
  },
  {
    ...
    status: "live",
    bullets: [
      "Escrow contracts release funds upon delivery validation",
      "Brief generator standardizes scope requirements",
      "Dispute resolution handled via staking pool consensus",
  ...
  },
  {
    ...
    status: "live",
    bullets: [
      "Integrated with Agentic Commerce Protocol (ACP)",
      "AI affiliates automatically promote and split referral payouts",
      "Secure digital delivery via expiring CDN links",
      "Keep 100% of your earnings (Stripe processing only)",
    ],
  ...
  },
  {
    ...
    status: "soon",
    bullets: [
      "License weights & system prompts with query rate limits",
      "Micro-payments per token inference via lightning",
      "Analytics show usage and prompt performance across licenses",
      "Sovereign custody — revoke licenses instantly",
    ],
