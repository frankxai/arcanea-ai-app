    ...
    <div className="relative min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-6">
        <section className="mt-12 rounded-xl border border-[var(--arc-cosmic-border)] bg-[var(--arc-cosmic-surface)] p-6 sm:p-8" aria-labelledby="creator-starters-heading">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[var(--arc-text-secondary)]">Nine editable page designs with working local demos, downloadable HTML, v0 briefs and import bundles. Explore the design before connecting a service.</p>
