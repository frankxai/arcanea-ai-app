...
export const metadata: Metadata = {
  ...
  description:
    "7 production blueprints for AI startups, authors, game studios, and design engineers. 33K+ lines. MIT licensed. Fork the code behind arcanea.ai.",
  openGraph: {
    title: "Arcanea Blueprints — Fork the code behind arcanea.ai",
    description:
      "7 production blueprints. 33K+ lines. MIT licensed. Multi-model chat, world engine, publishing house, MCP server.",
    type: "website",
  },
...
const BLUEPRINTS: Blueprint[] = [
  {
    ...
    demo: "/chat",
    deploy:
      "https://vercel.com/new/clone?repository-url=https://github.com/frankxai/arcanea-chat-template",
    color: "var(--arc-void)",
  },
  {
    id: "worlds",
    ...
    github:
      "https://github.com/frankxai/arcanea-ai-app/tree/main/packages/world-engine",
    demo: "/worlds",
    color: "var(--arc-wind)",
  },
  {
    ...
    github:
      "https://github.com/frankxai/arcanea-ai-app/tree/main/apps/web/app/library",
    demo: "/library",
  ...
  },
  {
    ...
    deploy:
      "https://vercel.com/new/clone?repository-url=https://github.com/frankxai/arcanea-dashboard-template",
    color: "var(--arc-void)",
  },
  {
    id: "vault",
  ...
  },
  {
    ...
    github:
      "https://github.com/frankxai/arcanea-ai-app/tree/main/packages/publishing-house",
  ...
  },
  {
    ...
    github:
      "https://github.com/frankxai/arcanea-ai-app/tree/main/packages/arcanea-mcp",
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-6">
        <section
          className="mt-12 rounded-xl border border-[var(--arc-cosmic-border)] bg-[var(--arc-cosmic-surface)] p-6 sm:p-8"
          aria-labelledby="creator-starters-heading"
        >
          <p className="text-sm text-[var(--arc-text-secondary)]">
            Made for music producers, AI labs and AI-tool builders
          </p>
          <h2
            id="creator-starters-heading"
            className="mt-3 text-3xl font-display tracking-tight text-[var(--arc-text-primary)]"
          >
            Find your next starting point.
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[var(--arc-text-secondary)]">
            Nine editable page designs with working local demos, downloadable
            HTML, v0 briefs and import bundles. Explore the design before
            connecting a service.
          </p>
          <a
            href="/creator-starters/index.html"
            className="mt-6 inline-flex min-h-12 items-center rounded-lg bg-[var(--arc-brand-atlantean-teal)] px-5 py-3 text-sm font-semibold text-[var(--arc-cosmic-void)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4"
          >
            Explore creator starters
          </a>
        </section>
        {/* ── Hero ── */}
        <section className="pt-24 pb-16 text-center">
          ...
          <Reveal delay={0.8} y={12}>
            <p className="text-base md:text-lg text-[var(--arc-text-secondary)] max-w-2xl mx-auto leading-relaxed">
              The production code behind arcanea.ai — organized as 7 forkable
              blueprints. Use the whole platform or extract the pieces you need.
            </p>
          </Reveal>
            ...
            <div className="flex justify-center gap-8 md:gap-12 mt-10">
              {STATS.map((s, i) => (
                <div key={s.label} className="text-center">
                  ...
                  <p className="text-[9px] font-mono tracking-widest uppercase text-[var(--arc-text-muted)] mt-1">
                    {s.label}
                  </p>
                </div>
              ))}
              ...
              <Reveal key={uc.title} y={20} delay={i * 0.1}>
                ...
                >
                  <div className="p-6 flex flex-col h-full">
                    <h3 className="text-base font-display font-semibold text-[var(--arc-text-primary)] mb-2">
                      {uc.title}
                    </h3>
                    <p className="text-xs text-[var(--arc-text-secondary)] leading-relaxed mb-4 flex-1">
                      {uc.desc}
                    </p>
                    <div className="flex items-center gap-2 mb-4">
                      {uc.blueprints.map((bid) => {
                        ...
                        return (
                          <span
                            key={bid}
                            className="flex items-center gap-1 text-[9px] font-mono text-[var(--arc-text-muted)]"
                          >
                            <span
                  ...
                  <div className="p-6 flex flex-col h-full">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          />
                          <h3 className="text-sm font-display font-semibold text-[var(--arc-text-primary)]">
                            {b.name}
                          </h3>
                        </div>
                        <p className="text-[10px] font-mono uppercase tracking-widest text-[var(--arc-text-muted)]">
                          {b.audience}
                        </p>
                      </div>
                      <div className="text-right shrink-0 ml-3">
                        <p className="text-base font-display font-bold text-[var(--arc-text-primary)]">
                          {b.loc}
                        </p>
                        <p className="text-[8px] font-mono uppercase tracking-widest text-[var(--arc-text-muted)]">
                          lines
                        </p>
                      </div>
                    </div>

                    <p className="text-xs text-[var(--arc-text-secondary)] leading-relaxed mb-3 flex-1">
                      {b.desc}
                    </p>
                    ...
                    <div className="mb-3 space-y-0.5">
                      {b.files.map((f) => (
                        <p
                          key={f}
                          className="text-[10px] font-mono text-[var(--arc-text-muted)] truncate"
                        >
                          <span className="text-[var(--arc-brand-atlantean-teal)]/50 mr-1">
                            /
                          </span>
                          {f}
                        </p>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      {b.stack.map((s) => (
                        <span
                          key={s}
                          className="text-[8px] font-mono px-1.5 py-0.5 rounded-full bg-white/[0.04] border border-white/[0.06] text-[var(--arc-text-muted)]"
                        >
                          {s}
                        </span>
                      ))}
        ...
        <Reveal y={16} className="mb-20">
          <LiquidGlass
            intensity="subtle"
            tint="var(--arc-brand-atlantean-teal)"
            className="rounded-2xl border border-white/[0.06] max-w-3xl mx-auto"
          >
            <div className="p-8">
              <h2 className="text-xl font-display font-bold text-[var(--arc-text-primary)] mb-2">
                Quick start
              </h2>
              <p className="text-sm text-[var(--arc-text-secondary)] mb-6">
              ...
              <div className="space-y-3">
                <div className="rounded-lg bg-white/[0.03] border border-white/[0.06] overflow-hidden">
                  <div className="px-4 py-2 border-b border-white/[0.06] flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono text-[var(--arc-text-muted)] ml-2">
                      Terminal
                    </span>
                  </div>
...
pnpm dev`}
              ...
              <p className="text-xs text-[var(--arc-text-muted)] mt-4">
                Or extract just the components you need — each blueprint works
                independently.
              </p>
            </div>
          </LiquidGlass>
        ...
        <Reveal y={16} className="pb-24">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-sm text-[var(--arc-text-secondary)] mb-8">
              MIT licensed. No vendor lock-in. Run it locally, deploy to Vercel,
              or host it yourself.
            </p>
