        ...
        <div className="liquid-glass rounded-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3 rounded-xl bg-black/40 border border-white/[0.06] focus:border-atlantean-teal focus:ring-1 focus:ring-atlantean-teal outline-none transition-all font-body text-text-primary placeholder:text-text-muted"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-12 py-3 rounded-xl bg-black/40 border border-white/[0.06] focus:border-atlantean-teal focus:ring-1 focus:ring-atlantean-teal outline-none transition-all font-body text-text-primary placeholder:text-text-muted"
                />
                <button
                  type="button"
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center ${
                          check.check ? 'bg-success' : 'bg-white/[0.06]'
                        }`}
                      >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-white/[0.06] hover:border-text-muted transition-colors font-body text-text-secondary"
            >
