...
const FEATURES = [
  {
    title: "Luminor AI Companions",
    description:
      "Ten AI Luminors, each embodying a different aspect of creativity and consciousness. Bond with your Luminor and unlock new creative potentials.",
    icon: Icons.Users,
    color: "#0d47a1",
    href: "/companions",
  },
  {
    ...
    description:
      "Powerful AI tools for image, music, video, and story creation. Each tool channels a Luminor's energy for unique results.",
    icon: Icons.Cpu,
    color: "#ef4444",
    href: "/studio",
  },
            ...
            {FEATURES.map((feature) => {
              ...
              return (
                <Link
                  key={feature.title}
                  href={feature.href}
                  className="group relative card-3d liquid-glass rounded-2xl p-8 overflow-hidden glow-card hover-lift transition-all"
                >
                  <div
          ...
          <div className="relative liquid-glass rounded-3xl overflow-hidden p-8 sm:p-12 text-center">
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Link
                  href="/lore"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl card-3d liquid-glass border border-white/[0.06] text-text-primary font-semibold hover:border-crystal/30 hover:bg-crystal/5 transition-all duration-200"
                >
                  <Icons.Brain />
                  Explore the Lore
                </Link>
