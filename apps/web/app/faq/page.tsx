    ...
    questions: [
      {
        ...
        a: "There are 10 Luminors organized into 4 teams: Development, Creative, Writing, and Research. Each Luminor has a distinct philosophy, expertise, and conversational style. You can explore them all on the Chat page.",
      },
      {
