    ...
    <div className="relative min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="liquid-glass rounded-xl p-5 animate-pulse">
                <div className="w-6 h-6 bg-white/[0.06] rounded mx-auto mb-2" />
                <div className="h-6 bg-white/[0.06] rounded w-12 mx-auto" />
                <div className="h-3 bg-white/[0.06] rounded w-20 mx-auto mt-2" />
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="card-3d liquid-glass rounded-2xl p-5 animate-pulse">
                ...
                <div className="h-5 bg-white/[0.06] rounded w-28 mb-2" />
        ...
        <section className="py-8 border-t border-white/[0.04] pb-16">
          <div className="h-5 bg-white/[0.06] rounded w-36 mb-6" />
          <div className="grid md:grid-cols-3 gap-6">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="card-3d liquid-glass rounded-2xl p-6 animate-pulse">
                <div className="flex justify-between mb-4">
                  <div className="w-4 h-4 bg-white/[0.06] rounded-full" />
