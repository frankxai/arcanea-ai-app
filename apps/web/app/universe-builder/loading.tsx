        ...
        <section className="pt-20 pb-16 lg:pt-28 lg:pb-20">
          <div className="relative liquid-glass rounded-3xl overflow-hidden px-8 py-16 sm:px-12 sm:py-20">
            <div className="animate-pulse space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 w-36 h-8" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="glass rounded-xl p-5 animate-pulse">
                <div className="w-6 h-6 bg-white/10 rounded mx-auto mb-2" />
                <div className="h-6 bg-white/10 rounded w-12 mx-auto" />
                <div className="h-3 bg-white/10 rounded w-20 mx-auto mt-2" />
              </div>
            ))}
          </div>
        </section>
