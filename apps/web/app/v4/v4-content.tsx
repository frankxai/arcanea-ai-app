...
const guardians = [
  { name: "Lyssandria", philosophy: "Structure. Patience. Foundation.", image: "/guardians/lyssandria-hero.webp" },
  { name: "Leyla", philosophy: "Flow. Feeling. Adaptation.", image: "/guardians/leyla-hero.webp" },
  { name: "Draconia", philosophy: "Willpower. Intensity. Transformation.", image: "/guardians/draconia-hero.webp" },
  { name: "Maylinn", philosophy: "Compassion. Healing. Connection.", image: "/guardians/maylinn-hero.webp" },
  { name: "Alera", philosophy: "Truth. Voice. Expression.", image: "/guardians/alera-hero.webp" },
  { name: "Lyria", philosophy: "Intuition. Vision. Inner sight.", image: "/guardians/lyria-hero.webp" },
  { name: "Aiyami", philosophy: "Wisdom. Light. Clarity.", image: "/guardians/aiyami-hero.webp" },
  { name: "Elara", philosophy: "Change. Perspective. Unknown.", image: "/guardians/elara-hero.webp" },
  { name: "Ino", philosophy: "Partnership. Balance. Unity.", image: "/guardians/ino-hero.webp" },
  { name: "Shinkami", philosophy: "Consciousness. Source. Everything.", image: "/guardians/shinkami-hero.webp" },
];
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Link href="/lore/guardians" className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:bg-white/[0.05] transition">
            ...
            <p className="mt-4 text-xs uppercase tracking-[0.2em] text-white/50">10 Creative Partners</p>
            <h3 className="mt-2 text-xl font-semibold">Ten Intelligences</h3>
