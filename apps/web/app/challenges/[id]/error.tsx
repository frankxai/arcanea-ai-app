    ...
    <div className="flex min-h-[60vh] items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <div className="flex justify-center gap-3">
          ...
          <Link href="/challenges" className="px-4 py-2 rounded-xl bg-[#00bcd4]/10 border border-[#00bcd4]/20 text-sm text-[#00bcd4] hover:bg-[#00bcd4]/20 transition-colors">All challenges</Link>
        </div>
      </div>
    </div>
  );
