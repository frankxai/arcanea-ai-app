...
export default function DocDetailError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-6">
      <div className="max-w-md text-center">
        <h2 className="font-display text-2xl font-bold text-white mb-3">Document not found</h2>
        <p className="text-white/40 text-sm mb-6">{error.message || 'This document may not exist yet.'}</p>
