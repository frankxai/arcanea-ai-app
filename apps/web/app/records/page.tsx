...
const PORTRAITS: GuardianPortrait[] = [
  { slug: "lyssandria", name: "Lyssandria", gate: "Foundation", gateNumber: 1, frequency: "174 Hz", element: "Earth", gradient: "from-amber-700 via-yellow-600 to-stone-400", accent: "text-amber-400", border: "border-amber-500/30", bg: "bg-amber-500/10", heroImage: "/guardians/v3/lyssandria-hero-v3.webp" },
  { slug: "leyla", name: "Leyla", gate: "Flow", gateNumber: 2, frequency: "285 Hz", element: "Water", gradient: "from-blue-300 via-cyan-400 to-slate-300", accent: "text-cyan-300", border: "border-cyan-400/30", bg: "bg-cyan-400/10", heroImage: "/guardians/v3/leyla-hero-v3.webp" },
  { slug: "draconia", name: "Draconia", gate: "Fire", gateNumber: 3, frequency: "396 Hz", element: "Fire", gradient: "from-red-600 via-orange-500 to-amber-400", accent: "text-orange-400", border: "border-orange-500/30", bg: "bg-orange-500/10", heroImage: "/guardians/v3/draconia-hero-v3.webp" },
  { slug: "maylinn", name: "Maylinn", gate: "Heart", gateNumber: 4, frequency: "417 Hz", element: "Wind", gradient: "from-rose-300 via-pink-400 to-green-300", accent: "text-pink-300", border: "border-pink-400/30", bg: "bg-pink-400/10", heroImage: "/guardians/v3/maylinn-hero-v3.webp" },
  { slug: "alera", name: "Alera", gate: "Voice", gateNumber: 5, frequency: "528 Hz", element: "Fire", gradient: "from-sky-400 via-blue-500 to-indigo-600", accent: "text-sky-300", border: "border-sky-400/30", bg: "bg-sky-400/10", heroImage: "/guardians/v3/alera-hero-v3.webp" },
  { slug: "lyria", name: "Lyria", gate: "Sight", gateNumber: 6, frequency: "639 Hz", element: "Void", gradient: "from-violet-500 via-purple-600 to-indigo-700", accent: "text-violet-300", border: "border-violet-500/30", bg: "bg-violet-500/10", heroImage: "/guardians/v3/lyria-hero-v3.webp" },
  { slug: "aiyami", name: "Aiyami", gate: "Crown", gateNumber: 7, frequency: "741 Hz", element: "Void", gradient: "from-yellow-200 via-amber-300 to-white", accent: "text-amber-300", border: "border-amber-400/30", bg: "bg-amber-400/10", heroImage: "/guardians/v3/aiyami-hero-v3.webp" },
  { slug: "elara", name: "Elara", gate: "Starweave", gateNumber: 8, frequency: "852 Hz", element: "Wind", gradient: "from-emerald-400 via-green-500 to-teal-600", accent: "text-emerald-300", border: "border-emerald-400/30", bg: "bg-emerald-400/10", heroImage: "/guardians/v3/elara-hero-v3.webp" },
  { slug: "ino", name: "Ino", gate: "Unity", gateNumber: 9, frequency: "963 Hz", element: "Earth", gradient: "from-pink-400 via-fuchsia-500 to-teal-400", accent: "text-fuchsia-300", border: "border-fuchsia-400/30", bg: "bg-fuchsia-400/10", heroImage: "/guardians/v3/ino-hero-v3.webp" },
  { slug: "shinkami", name: "Shinkami", gate: "Source", gateNumber: 10, frequency: "1111 Hz", element: "Spirit", gradient: "from-neutral-900 via-yellow-400 to-white", accent: "text-yellow-200", border: "border-yellow-300/30", bg: "bg-yellow-300/10", heroImage: "/guardians/v3/shinkami-hero-v3.webp" },
];
