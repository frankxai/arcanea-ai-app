      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="liquid-glass rounded-xl p-4 text-center">
                    <div className="h-8 bg-white/[0.06] rounded w-12 mx-auto mb-1" />
                    <div className="h-3 bg-white/[0.06] rounded w-20 mx-auto" />
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-2">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="h-9 w-16 bg-white/[0.06] rounded-lg" />
            ))}
          </div>
          <div className="flex items-center gap-3">
            <div className="h-9 w-48 bg-white/[0.06] rounded-xl" />
            <div className="h-9 w-9 bg-white/[0.06] rounded-lg" />
            <div className="h-9 w-16 bg-white/[0.06] rounded-lg" />
          </div>
        </section>
