...
const { GOLD, TEAL, BLUE, VIOLET, PINK, GREEN, AMBER, RED, CYAN, WHITE } =
  COLORS;
...
const innerRingNodes: RingNodeDef[] = [
  {
    ...
    description: "Multi-model orchestration, routing, and persona management.",
    color: BLUE,
    angle: 0,
  },
  {
    id: "memory-vaults",
    label: "Memory Vaults",
    description: "AgentDB, HNSW search, cross-session horizon layer.",
    color: VIOLET,
    angle: 90,
  },
  {
    ...
    description: "AI governance, quality gates, and consensus protocols.",
    color: GOLD,
    angle: 180,
  },
  {
    id: "statusline",
    label: "Statusline",
    description: "Real-time system health, agent monitoring, and diagnostics.",
    color: GREEN,
    angle: 270,
  },
];
...
const middleRingNodes: RingNodeDef[] = [
  {
    id: "claude-arcanea",
    label: "claude-arcanea",
    description:
      "20 creator skills overlay for Claude Code. MCP server and agent harness.",
    color: TEAL,
    angle: 30,
  },
  {
    ...
    label: "arcanea-code",
    description:
      "Code intelligence agent with semantic analysis and refactoring.",
    color: BLUE,
    angle: 120,
  },
  {
    id: "oh-my-arcanea",
    label: "oh-my-arcanea",
    description: "Shell integration and terminal experience enhancement.",
    color: GREEN,
    angle: 210,
  },
  {
    ...
    label: "Orchestrator",
    description: "Multi-agent swarm coordination with hierarchical topology.",
    color: VIOLET,
    angle: 300,
  },
];
...
const outerRingNodes: RingNodeDef[] = [
  {
    id: "arcanea-claw",
    label: "Arcanea Claw",
    description: "Media generation CLI. Image, video, and audio pipelines.",
    color: PINK,
    angle: 0,
  },
  {
    ...
    label: "InfoGenius",
    description:
      "Research synthesis agent. Web search, analysis, visual reports.",
    color: CYAN,
    angle: 72,
  },
  {
    ...
    label: "Author OS",
    description:
      "Book publishing pipeline behind the Chronicles and the Library.",
    color: AMBER,
    angle: 144,
  },
  {
    id: "suno-mcp",
    label: "Suno MCP",
    description: "Music creation via Suno AI. Frequency-aligned compositions.",
    color: RED,
    angle: 216,
  },
  {
    id: "arcanea-vault",
    label: "Arcanea Vault",
    description: "Knowledge capture and archival with semantic search.",
    color: GREEN,
    angle: 288,
  },
];
...
const farRingNodes: RingNodeDef[] = [
  {
    id: "vscode",
    label: "VS Code",
    description: "Visual Studio Code extension with embedded agent panels.",
    color: BLUE,
    angle: 20,
  },
  {
    id: "chrome",
    label: "Chrome",
    description: "Browser extension for web research and content capture.",
    color: TEAL,
    angle: 92,
  },
  {
    id: "open-webui",
    label: "Open WebUI",
    description: "Self-hosted chat interface with Arcanea personality layer.",
    color: WHITE,
    angle: 164,
  },
  {
    id: "lobechat",
    label: "LobeChat",
    description: "LobeChat provider integration for multi-model routing.",
    color: VIOLET,
    angle: 236,
  },
  {
    id: "mobile",
    label: "Mobile",
    description: "Companion app for iOS and Android with offline support.",
    color: PINK,
    angle: 308,
  },
];
...
const centerNode: ConstellationNode = {
  ...
  data: {
    label: "Arcanea",
    description:
      "The creative superintelligence platform. Chat, imagine, build, publish.",
    color: GOLD,
    size: 72,
    ring: "center",
  },
