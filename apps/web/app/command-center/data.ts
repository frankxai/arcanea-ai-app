...
export const MILESTONES: Milestone[] = [
  {
    id: 'M001',
    name: 'Supabase Auth',
    description: 'Full authentication flow with Supabase — SSR-safe client, profile bootstrap, social login, RLS policies.',
    guardian: 'Lyssandria',
    element: 'crystal',
    progress: 60,
    status: 'active',
  ...
  },
  {
    ...
    description: 'Video hosting and streaming via Cloudflare Stream — upload pipeline, player component, CDN delivery.',
    guardian: 'Leyla',
    element: 'water',
    progress: 0,
    status: 'planned',
  ...
  },
  {
    id: 'M003',
    name: 'Memory System',
    description: 'StarlightVaults with 6 vaults, ArcaneMD format, CLI binary, MEMORY.md bridge. 38/38 tests passing.',
    guardian: 'Lyria',
    element: 'void',
    progress: 75,
    status: 'active',
  ...
  },
  {
    id: 'M004',
    name: 'PM Toolkit',
    description: 'Git-native project management with .arc format, milestones, sprints, and velocity tracking.',
    guardian: 'Shinkami',
    element: 'gold',
    progress: 40,
    status: 'active',
