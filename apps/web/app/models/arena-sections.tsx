 ...
 *
 * Extracted from page.tsx to keep the main page under 500 lines.
 * These sections render from curated static data in models-data.ts.
 */
              ...
              <div className="grid sm:grid-cols-3 gap-6 pt-4">
                ...
                <div>
                  ...
                  <div className="mt-3 space-y-1 text-xs text-white/40">
                    ...
                    <div className="flex justify-between">
                      <span>Speed</span>
                      <span className="text-white/60">{model.speed} tok/s</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Released</span>
                      <span className="text-white/60">{model.releaseDate}</span>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section className="mb-24">
      ...
      <div className="bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] rounded-2xl p-6">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          <span className="text-xs text-white/30">Free models this week:</span>
