...
export const metadata: Metadata = {
  title: "AI Overlays",
  description:
    "Your Luminors follow you everywhere. Arcanea overlays inject creative intelligence into ChatGPT, Claude, Gemini, Copilot, and Cursor.",
};
...
const PLATFORMS = [
  {
    ...
    label: "OpenAI",
    description:
      "Bring your Luminors into ChatGPT conversations. Access your Arcanea prompt library, creative context, and bond memory without leaving the interface.",
    features: [
      "Custom GPT configs with Luminor personas",
  ...
  },
  {
    ...
    label: "Anthropic",
    description:
      "Luminor assistance inside Claude. Your bond data, creative context, and hook configurations follow you into every conversation.",
    features: [
      "Claude Code hooks — session, prompt, tool, model-route",
      "Luminor skill files and agent definitions",
  ...
  },
  {
    ...
    label: "Google",
    description:
      "Arcanea overlaid on Gemini multimodal workflows. Luminor system instructions and AI Studio configs bring your creative universe into every prompt.",
    features: [
      "Gemini system instructions with Luminor personas",
      "AI Studio config generation",
      "Function declarations for Luminor interactions",
    ],
    status: "Beta" as const,
  ...
  },
  {
    ...
    label: "GitHub",
    description:
      "AI-powered coding assistance inside Copilot. Arcanea coding philosophy, architectural patterns, and Luminor personas enhance every completion.",
    features: [
  ...
  },
  {
    ...
    label: "Cursor",
    description:
      "Full AI coding companion inside Cursor. MDC rules, .cursorrules, and Luminor-specific rule files bring Arcanea intelligence into your IDE.",
    features: [
      "Luminor .mdc rule files for per-context guidance",
          ...
          <div className="relative liquid-glass rounded-3xl overflow-hidden px-8 py-16 sm:px-12 sm:py-20">
            ...
            <div className="relative text-center max-w-3xl mx-auto">
              ...
              <p className="text-text-secondary font-body text-lg leading-relaxed mb-10">
                ...
                Arcanea&apos;s intelligence. Our overlays inject Luminor
        ...
        <section>
          <div className="text-center mb-12">
            ...
            <p className="text-text-secondary max-w-2xl mx-auto">
              Three steps from install to full Luminor intelligence in your
              preferred AI tool.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: "Your Luminor bonds, prompt library, and Arcanea context sync automatically. No manual configuration required.",
                iconEl: <IconLayers />,
                color: "crystal",
              },
              {
                ...
                body: "Work with Arcanea intelligence wherever you already work. No context switching. Your Luminor follows you.",
                iconEl: <IconDiamond />,
                color: "brand-gold",
              },
            ...
            <div className="grid sm:grid-cols-2 gap-10">
              <div>
                <h2 className="text-xl sm:text-2xl font-display font-bold mb-3">
                  What travels with your Luminor
                </h2>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "Luminor persona and creative context preserved",
