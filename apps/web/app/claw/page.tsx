...
const PIPELINE_STEPS = [
  ...
  },
  {
    ...
    name: "Classify",
    description:
      "AI identifies characters, scenes, elements, and canon entities",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    name: "Score",
    description:
      "TASTE evaluation: Technical, Aesthetic, Storytelling, Thematic, Emotional",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    name: "Upload",
    description:
      "Push to Supabase Storage with metadata, tags, and scoring data",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    name: "Notify",
    description:
      "Command Center alerts — approve, reject, or tweak from any device",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
const DEPLOY_OPTIONS = [
  {
    ...
    description:
      "Deploy to Railway with a single click. Persistent storage, auto-scaling, environment variables pre-configured.",
  ...
  },
  {
    ...
    description:
      "Run on your own infrastructure. Full control over storage paths, scheduling, and network access.",
  ...
  },
  {
    ...
    subtitle: "MCP Skills",
    description:
      "Use ArcaneaClaw skills directly in Claude Code. Process media, score images, and manage your pipeline from the terminal.",
            ...
            <div className="relative liquid-glass rounded-3xl overflow-hidden px-8 py-16 sm:px-14 sm:py-20">
              ...
              <div className="relative text-center max-w-3xl mx-auto">
                ...
                <p className="text-base text-text-muted max-w-2xl mx-auto mb-10 leading-relaxed">
                  Your AI processes, classifies, scores, and publishes your
                  creative media — while you sleep. From raw files scattered
                  across drives to a curated, scored, published gallery.
                </p>
          ...
          <section className="mb-20" aria-labelledby="pipeline-heading">
            <div className="text-center mb-12">
              ...
              <p className="text-text-muted mt-3 max-w-xl mx-auto">
                From raw media on your drives to scored, tagged, published
                content — every step handled by a specialized AI skill.
              </p>
            </div>
              ...
              {PIPELINE_STEPS.map((step, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-xs font-mono text-gold-bright/60">
                      {step.step}
                    </span>
          ...
          <section className="mb-20" aria-labelledby="features-heading">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {FEATURES.map((feature) => (
                ...
                >
                  <div
                    className={`bg-gradient-to-br ${feature.color} rounded-xl w-14 h-14 flex items-center justify-center mb-6 ${feature.accentColor}`}
                  >
                    {feature.icon}
                  </div>
                  ...
                  <p
                    className={`text-xs font-mono ${feature.accentColor} mb-3`}
                  >
                    {feature.subtitle}
                  </p>
          ...
          <section>
            <div className="liquid-glass rounded-3xl px-8 py-14 sm:px-14 text-center border border-gold-bright/10">
              ...
              <p className="text-text-secondary max-w-lg mx-auto mb-8">
                Stop organizing files. Start publishing art. ArcaneaClaw turns
                your creative chaos into a curated, scored, published body of
                work.
              </p>
