...
const PATHS = [
  {
    ...
    description:
      'Shape a thinking entity. Choose its domain, voice, and personality. It becomes your creative partner — chat-capable, exportable, uniquely yours. Published Luminors appear in The Sanctum for others to discover and use.',
    color: '#00bcd4',
    ...
    <LazyMotion features={domAnimation}>
      <div className="min-h-screen bg-[#09090b] text-white">
        ...
        <section className="relative overflow-hidden px-6 pb-16 pt-24 text-center md:pt-32">
          ...
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,rgba(0,137,123,0.04)_0%,transparent_50%)]" />
          ...
          >
            ...
            <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-white/45">
              ...
              thinks with you. A <span className="text-[#00897b]">Companion</span> that travels beside you.
          ...
          >
            ...
            <div className="mx-auto max-w-md space-y-3 text-sm leading-relaxed text-white/35">
              ...
              <p>
                ...
                <span className="text-[#00897b]/80">Companion</span>{' '}
                <span className="text-white/20">=</span>{' '}
