      ...
      <main className="max-w-4xl mx-auto px-6">
        ...
        >
          {VAULT_CATEGORIES.map((c) => {
            ...
            return (
              ...
              >
                <Link
                  href={`/starlight-intelligence/vault/${c}`}
        ...
        >
          ...
          <p className="text-xs text-[var(--arc-text-muted)] mt-1 font-mono">
            ...
            {entries.length > 0 && (
              <> · Latest {timeAgo(entries[0].createdAt)}</>
            )}
          </p>
        </m.div>
        ...
        {entries.length > 0 ? (
          ...
          >
            ...
            <p className="text-[var(--arc-text-muted)]/50 text-xs mt-1">
              Entries appear here as the vault grows.
            </p>
          </m.div>
        )}
      </main>
