...
export default function QuizError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-12 bg-[var(--arc-cosmic-void)]">
      ...
      <h2 className="mb-2 text-xl font-bold text-[var(--arc-brand-atlantean-teal)] font-display">The Gate could not open</h2>
      <p className="mb-6 max-w-sm text-center text-sm text-white/50">Something went wrong loading the quiz. Your origin still awaits.</p>
      <div className="flex gap-3">
        ...
        <Link href="/factions" className="rounded-lg px-5 py-2.5 text-sm font-semibold bg-white/5 border border-white/10 text-white/60 font-display hover:bg-white/8 transition-colors">
          View Factions
        </Link>
      </div>
    </div>
