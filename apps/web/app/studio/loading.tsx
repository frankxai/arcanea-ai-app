      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          <div className="relative liquid-glass rounded-3xl overflow-hidden px-8 py-12 sm:px-12 sm:py-16">
            <div className="animate-pulse space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/[0.06] bg-white/[0.04] w-40 h-8" />
              <div className="h-12 bg-white/[0.06] rounded-lg w-3/4" />
              <div className="h-6 bg-white/[0.06] rounded-lg w-1/2" />
              <div className="h-20 bg-white/[0.06] rounded-lg w-full mt-8" />
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            {[...Array(5)].map((_, i) => (
              <div key={i} className="card-3d liquid-glass rounded-2xl p-6 animate-pulse">
                ...
                <div className="h-4 bg-white/[0.06] rounded w-1/2 mb-4" />
        ...
        <section className="mt-16">
          <div className="card-3d liquid-glass rounded-2xl p-8">
            <div className="h-8 bg-white/[0.06] rounded w-64 mb-6" />
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-6">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="text-center animate-pulse">
                  <div className="w-12 h-12 bg-white/[0.06] rounded-full mx-auto mb-3" />
                  <div className="h-5 bg-white/[0.06] rounded w-16 mx-auto" />
