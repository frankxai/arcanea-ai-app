                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select className="w-full mt-2 bg-white/[0.04] border border-white/[0.06] rounded-lg p-2 text-sm focus:border-draconic-crimson focus:outline-none focus:ring-2 focus:ring-draconic-crimson/20">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full mt-2 bg-white/[0.04] border border-white/[0.06] rounded-lg p-2 text-sm focus:border-draconic-crimson focus:outline-none focus:ring-2 focus:ring-draconic-crimson/20"
                      />
                    </div>
                  </div>
                </m.div>
