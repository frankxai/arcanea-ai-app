...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Resource Hub",
    description: "Your central hub for Arcanea resources, updates, guides, and tools.",
  },
};
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {QUICK_LINKS.map((link) => (
              <Link
                ...
                className="flex items-center gap-3 p-4 rounded-xl liquid-glass hover:border-atlantean-teal-aqua/30 hover:bg-atlantean-teal-aqua/5 transition-all"
              >
