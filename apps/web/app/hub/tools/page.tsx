...
const TOOLS = [
  {
    id: "chat",
    name: "AI Chat",
    description: "Conversational AI with 16 specialized intelligences. Each specialist brings unique expertise to your creative challenges.",
    status: "available",
    icon: "💬",
    color: "#0d47a1",
    href: "/chat",
    features: ["16 AI specialists", "Domain expertise", "Memory & context"],
  },
  {
    id: "library",
    name: "Wisdom Library",
