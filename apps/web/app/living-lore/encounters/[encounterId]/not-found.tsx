...
export default function NotFound() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      ...
      <h2 className="font-display text-xl text-text-primary mb-2">Encounter Not Found</h2>
      <p className="text-sm text-text-muted mb-6">This scene hasn&apos;t manifested yet.</p>
