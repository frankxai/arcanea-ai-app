    ...
    <div className="flex min-h-[60vh] items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <div className="flex justify-center gap-3">
          ...
          <Link href="/living-lore" className="px-4 py-2 rounded-xl bg-[var(--arc-brand-atlantean-teal)]/10 border border-[var(--arc-brand-atlantean-teal)]/20 text-sm text-[var(--arc-brand-atlantean-teal)] hover:bg-[var(--arc-brand-atlantean-teal)]/20 transition-colors">Living Lore</Link>
        </div>
      </div>
    </div>
  );
