      ...
      <article className="mx-auto max-w-3xl px-6 py-24">
        ...
        <Section title="In one sentence">
          <p>
            ...
            <code className="mx-1 rounded bg-white/[0.05] px-1.5 py-0.5 text-[var(--arc-brand-atlantean-teal)]">
        ...
        <Section title="What the extension does not do">
          <ul className="list-inside list-disc space-y-2">
            ...
            <li>
              ...
              &quot;ping home&quot; requests. The extension makes zero network
              requests to Arcanea or any third party unless you click the
              optional Send-to-Arcanea button (see below).
            </li>
            <li>
        ...
        <Section title="The optional Send-to-Arcanea bridge">
          <p>
            ...
            <span className="rounded bg-white/[0.05] px-1.5 py-0.5 text-[var(--arc-brand-arcanean-gold)]">
        ...
        <Section title="Data retention">
          ...
          <p className="mt-3">
            ...
            ) is kept for at most 30 days in Vercel&apos;s standard log
            retention, then rotated. No conversation bodies are persisted
            server-side at this version.
          </p>
        </Section>
        ...
        <Section title="Open source">
          <p>
            ...
            <Link
              ...
              className="text-[var(--arc-brand-atlantean-teal)] underline-offset-4 hover:underline"
            >
        ...
        <Section title="Changes to this policy">
          <p>
            ...
            Older versions of the policy are kept in the project&apos;s git
            history at the repo above.
          </p>
        </Section>
