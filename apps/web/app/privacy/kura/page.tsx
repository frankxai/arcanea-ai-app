      ...
      <article className="mx-auto max-w-3xl px-6 py-24">
        <header className="mb-12 border-b border-white/[0.06] pb-8">
          ...
          <p className="mt-4 text-lg text-zinc-400">
            ...
            Arcanea Kura Chrome extension touches, where it goes, and what
        ...
        <Section title="In one sentence">
          <p>
            The extension reads the AI conversation on the tab you're
            currently looking at, writes it as a Markdown file into
            <code className="mx-1 rounded bg-white/[0.05] px-1.5 py-0.5 text-[#00bcd4]">~/Downloads/ArcaneaKura/</code>{' '}
        ...
        <Section title="What the extension can access">
          <ul className="list-inside list-disc space-y-2">
            <li>
              The DOM of the active tab when you click the extension icon —
              only on the AI platforms listed in the manifest{' '}
              <span className="text-zinc-500">
                (ChatGPT, Claude, Gemini, Grok, DeepSeek, Perplexity).
              </span>
            </li>
            <li>
              Chrome's <code className="rounded bg-white/[0.05] px-1.5 py-0.5">downloads</code> API,
              used to write files into your default Downloads folder.
            </li>
            <li>
              Chrome's <code className="rounded bg-white/[0.05] px-1.5 py-0.5">storage</code> API,
              used to persist your preferences (export format, default
              platform filter). Settings only — no conversation content.
            </li>
            <li>
              <code className="rounded bg-white/[0.05] px-1.5 py-0.5">IndexedDB</code> inside the
              extension, used as a lookup index for fast cross-conversation
              queries. The filesystem is the canonical store; IndexedDB is
              a cache.
            </li>
          </ul>
        </Section>
        ...
        <Section title="What the extension does not do">
          <ul className="list-inside list-disc space-y-2">
            ...
            <li>
              <strong className="text-zinc-100">No telemetry.</strong> No
              "ping home" requests. The extension makes zero network requests
              to Arcanea or any third party unless you click the optional
              Send-to-Arcanea button (see below).
            </li>
            <li>
              <strong className="text-zinc-100">No account.</strong> Nothing
              to sign up for. Nothing to log in to.
            </li>
            <li>
              <strong className="text-zinc-100">No third-party scripts.</strong>{' '}
              The popup loads Google Fonts CSS only; we plan to self-host
              fonts in v0.3 to remove this last external request.
            </li>
            <li>
        ...
        <Section title="The optional Send-to-Arcanea bridge">
          ...
          <ul className="mt-3 list-inside list-disc space-y-2">
            <li>
              ...
              <code className="rounded bg-white/[0.05] px-1.5 py-0.5">https://arcanea.ai/api/kura/import</code>.
            </li>
            <li>
              The payload contains the conversation metadata, messages,
              prompts, and any AI-generated media references — same content
              that was just written to your disk.
            </li>
            <li>
              The Arcanea bridge endpoint logs only metadata (counts,
              platform, schema version, first three conversation titles) and
              returns a server-side capture id.
            </li>
            <li>
              Persistence of conversation bodies into the Arcanea second
              brain is deferred until a future version and will require an
              explicit opt-in beyond the button click.
            </li>
          </ul>
          <p className="mt-3">
        ...
        <Section title="Data retention">
          <p>
            Files captured to <code className="rounded bg-white/[0.05] px-1.5 py-0.5">~/Downloads/ArcaneaKura/</code>{' '}
            remain on your machine until you delete them. The IndexedDB
            cache is cleared when you uninstall the extension.
          </p>
          <p className="mt-3">
            Metadata logged by the optional bridge endpoint
            (<code className="rounded bg-white/[0.05] px-1.5 py-0.5">/api/kura/import</code>) is
            kept for at most 30 days in Vercel's standard log retention, then
            rotated. No conversation bodies are persisted server-side at
            this version.
          </p>
        </Section>
        ...
        <Section title="Changes to this policy">
          <p>
            ...
            effective date at the top of this page reflects the current
            version. Older versions of the policy are kept in the project's
            git history at the repo above.
          </p>
        </Section>

        <footer className="mt-16 border-t border-white/[0.06] pt-8 text-sm text-zinc-500">
          <Link href="/kura" className="text-[#00bcd4] underline-offset-4 hover:underline">
