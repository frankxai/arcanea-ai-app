...
const SUGGESTION_POOLS: Record<ContentType, string[]> = {
  character: [
    'Develop their origin story and what shaped them',
    'Design their signature ability or artifact',
    'Create a rival who mirrors their greatest flaw',
    'Place them in a scene that tests their core belief',
  ...
  world: [
    'Define the magic system and its costs',
    'Create the major factions and their conflicts',
    'Write the founding myth of this world',
    'Design a key city or settlement',
  ...
  story: [
    'Develop the next chapter from here',
    'Explore this moment from another character\'s view',
    'Create a twist that reframes everything so far',
    'Write the scene everyone will remember',
    ...
    'Create the antagonist\'s perspective on these events',
  ],
  code: [
