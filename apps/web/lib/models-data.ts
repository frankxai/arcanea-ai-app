...
export const AI_MODELS: AIModel[] = [
...

  {
    ...
    category: 'frontier',
    tags: ['prose', 'high-fantasy', 'character-voice', 'editors-choice', 'extended-thinking'],
    worldCraftScore: 98,
    proseQuality: 99,
    loreMemory: 96,
    magicLogic: 95,
  ...
  },
  {
    ...
    category: 'frontier',
    tags: ['mythic-prose', 'cosmology', 'crown-gate', 'epic-sagas', 'philosophy'],
    worldCraftScore: 97,
    proseQuality: 98,
    loreMemory: 97,
    magicLogic: 96,
  ...
  },
  {
    ...
    category: 'open-source',
    tags: ['open-weights', 'self-host', 'sovereign', 'dark-fantasy', '1m-tokens'],
    worldCraftScore: 89,
    proseQuality: 86,
    loreMemory: 95,
    magicLogic: 88,
  ...
  },
  {
    ...
    weaknesses: [
      'Rate-limited on free gateway during peak traffic',
    ],
    category: 'free-tier',
  ...
  },
  {
    ...
    weaknesses: [
      'Prose style is analytical rather than lyrical',
    ],
    category: 'free-tier',
...
export const IMAGE_MODELS: ImageModel[] = [
  ...
  },
  {
    ...
    weaknesses: [
      'Less fine-grained artistic style customization than FLUX',
    ],
    category: 'frontier',
