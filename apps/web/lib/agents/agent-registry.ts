...
export const AGENT_REGISTRY: AgentDefinition[] = [
  ...
  { id: "onchain-architect", name: "Onchain Architect", type: "onchain-architect", category: "specialized", capabilities: ["smart-contracts", "onchain-economy", "guardian-assets"], gate: "Fire", guardian: "Draconia", description: "Economic layer and smart contract specialist", status: "active" },
  { id: "mobile-specialist", name: "Mobile Specialist", type: "mobile-specialist", category: "specialized", capabilities: ["flutter", "compose", "mobile-ux"], gate: "Flow", guardian: "Leyla", description: "Multiplatform mobile development specialist", status: "active" },
  { id: "media-engine", name: "Media Engine", type: "media-engine", category: "specialized", capabilities: ["video-processing", "image-generation", "automation"], gate: "Flow", guardian: "Leyla", description: "AI media and video pipeline specialist", status: "active" },
  { id: "knowledge-scout", name: "Knowledge Scout", type: "knowledge-scout", category: "specialized", capabilities: ["mcp-integration", "information-retrieval", "visual-intelligence"], gate: "Sight", guardian: "Lyria", description: "Knowledge retrieval and MCP intelligence specialist", status: "active" },
