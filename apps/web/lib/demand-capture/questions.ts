...
export const PAIN_PROMPT =
  "What are you trying to do that this would help with?";
...
export const ROLES: Record<string, string[]> = {
  ...
  "books-arcanea-legends": [
    "Fantasy reader",
    "Writer",
    "Worldbuilder",
    "Came for the AI, stayed for the story",
  ],
  "agentic-income": [
    "Solo operator",
    "Agency owner",
  ...
  "starlight-signal": [
    "Head of events",
    "Event ops / production",
    "Marketing lead",
    "Data / analytics",
    "Agency running events for clients",
    "Speaker or programme curator",
  ],
};

export const rolesFor = (productId: string) =>
  ROLES[productId] ?? ROLES.default;
