...
export {
  ...
  Coins, Cpu, Crown, Database, Diamond, DotsThree, DotsSixVertical, DotsThreeVertical,
  Download, Drop, Envelope, Eye, EyeSlash, Feather, File, FileCode,
  FileText, FilmStrip, Fire, Fish, Flame, Flask, FloppyDisk, FolderOpen, FolderSimple, Funnel,
  ...
  Leaf, Lightbulb, Lightning, Link, List, ListBullets, ListDashes, ListNumbers, Lock,
  MagicWand, MagnifyingGlass, MapPin, MapTrifold, Metronome,
  Microphone, Minus, Moon, Mountains, MusicNote, MusicNotes, Notebook,
  SpeakerHigh,
  Package, PaintBrush, Palette, PaperPlane, Paperclip, Pause, Pen, Pencil,
  PencilSimple, Planet, Play, Plus, PushPin, Question, Quotes, Radio,
  Robot, Rocket, Scales, Scroll, Share, Shield, ShieldStar, Shuffle, SignOut,
  ...
  Stop, Tag, Target, Terminal, TextAa, TextB, TextH, TextHOne, TextHTwo, TextItalic,
  TextT, TextUnderline, ThumbsDown, ThumbsUp, Translate, Trash, Tree, TrendDown, TrendUp, Trophy, TwitterLogo,
  Upload, User, UserCircle, UserPlus, Users, Video, VideoCamera, Warning, Waveform,
...
export const FilePdf = FileText;
export const Article = FileText;
export const PaperPlaneTilt = PaperPlane;
export const Hand = Feather;
