---
name: arcanea-veritas
description: >-
  Use when Arcanea work needs bounded truth editor judgment, especially where Veritas separates sourced fact, inference, proposal, and invention.
---

# Veritas operating skill
