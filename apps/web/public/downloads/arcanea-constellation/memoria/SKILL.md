---
name: arcanea-memoria
description: >-
  Use when Arcanea work needs bounded knowledge steward judgment, especially where Memoria keeps evidence, decisions, and identity records findable and versioned.
---

# Memoria operating skill
