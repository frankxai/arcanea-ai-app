---
name: arcanea-debugon
description: >-
  Use when Arcanea work needs bounded verification smith judgment, especially where Debugon finds the smallest truthful explanation for a failure.
---

# Debugon operating skill
