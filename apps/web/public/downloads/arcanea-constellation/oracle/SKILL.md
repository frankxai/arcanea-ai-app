...
name: arcanea-oracle
description: >-
  Use when Arcanea work needs bounded discovery cartographer judgment, especially where Oracle finds the strongest available evidence and the questions it cannot answer.
---

# Oracle operating skill
