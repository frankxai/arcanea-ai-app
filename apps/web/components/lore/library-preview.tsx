...
> = {
  ...
  "atlantean-teal-aqua": {
    ...
    text: "text-atlantean-teal-aqua",
    bg: "bg-atlantean-teal-aqua/20",
    shimmer: "cyan",
  },
  "creation-prism-purple": {
    glow: "rgba(13, 71, 161, 0.12)",
    dot: "var(--arc-brand-cosmic-blue)",
    text: "text-creation-prism-purple",
    bg: "bg-creation-prism-purple/20",
    shimmer: "purple",
  },
  "draconic-crimson": {
    glow: "rgba(239, 68, 68, 0.12)",
    dot: "var(--arc-fire)",
    text: "text-draconic-crimson",
    bg: "bg-draconic-crimson/20",
    shimmer: "fire",
  },
};
