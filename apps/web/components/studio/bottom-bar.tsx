...
export function BottomBar({
  ...
  return (
    <footer className="shrink-0 h-14 border-t border-[rgba(139,92,246,0.15)] bg-[#0d0d15] px-5 flex items-center justify-between gap-4">
      {/* Left — Save / Draft actions */}
      <div className="flex items-center gap-2">
        <button
          onClick={onSave}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-muted-foreground border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] hover:text-foreground hover:border-[rgba(139,92,246,0.25)] hover:bg-[rgba(139,92,246,0.06)] transition-all duration-200"
        >
          <FloppyDisk size={13} />
          Save Draft
        </button>
        ...
        <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-muted-foreground border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] hover:text-foreground hover:border-[rgba(139,92,246,0.25)] hover:bg-[rgba(139,92,246,0.06)] transition-all duration-200">
          <Eye size={13} />
          Preview
        </button>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {generationState === "generating" && (
          <div className="flex items-center gap-1.5">
            <ArrowsClockwise size={12} className="text-[#8b5cf6] animate-spin" />
            <span className="text-[11px] text-[#8b5cf6] font-mono">Weaving…</span>
          </div>
        )}
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={cn(
            ...
            isGenerating
              ? "bg-[rgba(139,92,246,0.2)] text-[#8b5cf6] border border-[rgba(139,92,246,0.3)] cursor-not-allowed"
              : "bg-gradient-to-r from-[#8b5cf6] to-[#7c3aed] text-white hover:from-[#9d70f8] hover:to-[#8b5cf6] shadow-lg shadow-[rgba(139,92,246,0.3)] glow-violet"
          )}
        >
