...
const PILLARS = [
  ...
  },
  {
    ...
    description:
      "16 AI specialists — Development, Creative, Writing, Research. Deploy the right one for every stage.",
  },
] as const;
  ...
  return (
    <div ref={ref} className="relative flex items-center justify-center w-full">
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/[0.12] to-transparent"
        style={{ originX: 0 }}
      />
