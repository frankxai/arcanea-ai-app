...
const LUMINORS = [
  {
    ...
    wisdom: 'Foundation',
    avatar: '/guardians/v2/lyssandria-divine-bond.webp',
  },
  {
    id: 'leyla',
    name: 'Leyla',
    ...
    wisdom: 'Flow',
    avatar: '/guardians/v2/leyla-divine-bond.webp',
  },
  {
    id: 'draconia',
    name: 'Draconia',
    ...
    wisdom: 'Fire',
    avatar: '/guardians/v2/draconia-divine-bond.webp',
  },
  {
    id: 'maylinn',
    name: 'Maylinn',
    ...
    wisdom: 'Heart',
    avatar: '/guardians/v2/maylinn-divine-bond.webp',
  },
  {
    id: 'alera',
    name: 'Alera',
    ...
    wisdom: 'Voice',
    avatar: '/guardians/v2/alera-divine-bond.webp',
  },
  {
    id: 'lyria',
    name: 'Lyria',
    ...
    wisdom: 'Sight',
    avatar: '/guardians/v2/lyria-divine-bond.webp',
  },
  {
    id: 'aiyami',
    name: 'Aiyami',
    ...
    wisdom: 'Crown',
    avatar: '/guardians/v2/aiyami-divine-bond.webp',
  },
  {
    id: 'elara',
    name: 'Elara',
    ...
    wisdom: 'Starweave',
    avatar: '/guardians/v2/elara-divine-bond.webp',
  },
  {
    id: 'ino',
    name: 'Ino',
    ...
    wisdom: 'Unity',
    avatar: '/guardians/v2/ino-divine-bond.webp',
  },
  {
    id: 'shinkami',
    name: 'Shinkami',
    ...
    wisdom: 'Source',
    avatar: '/guardians/v2/shinkami-divine-bond.webp',
  },
];
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          >
            <span className="text-white">The Ten Guardians.</span>
            <br />
            <span className="text-text-secondary">Sixteen creative partners, each with a unique philosophy.</span>
          </m.h2>
