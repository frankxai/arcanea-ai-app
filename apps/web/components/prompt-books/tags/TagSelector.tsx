      ...
      <div className="px-3 py-2 border-b border-white/[0.04]">
        <div className="flex items-center gap-2 liquid-glass rounded-lg px-2 py-1.5">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-xs font-sans text-text-primary placeholder:text-text-muted/40 focus:outline-none focus:ring-1 focus:ring-[var(--arc-brand-atlantean-teal)]/20"
            autoFocus
          />
        </div>
      </div>
