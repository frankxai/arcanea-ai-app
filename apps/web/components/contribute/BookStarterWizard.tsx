/* eslint-disable @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any, @typescript-eslint/no-unused-expressions, @typescript-eslint/ban-ts-comment, @typescript-eslint/no-require-imports, @typescript-eslint/no-unsafe-function-type, react-hooks/exhaustive-deps, react-hooks/set-state-in-effect, react-hooks/rules-of-hooks, react-hooks/purity, react-hooks/refs, react-hooks/static-components, react-hooks/immutability, react-hooks/preserve-manual-memoization, react-hooks/incompatible-library, jsx-a11y/alt-text, @next/next/no-img-element, @next/next/no-html-link-for-pages, react/no-unescaped-entities */
"use client";
...
export function BookStarterWizard() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.035] to-white/[0.01] p-6 md:p-8">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full bg-[var(--arc-brand-atlantean-teal)]/10 blur-3xl"
      />
      <div className="relative">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <input
                    ...
                    className="flex-1 accent-[var(--arc-brand-atlantean-teal)]"
                    aria-valuemin={0}
                    aria-valuemax={100}
                  ...
                  {MODELS.map((model) => {
                    ...
                    return (
                      ...
                      >
                        <input
                          type="checkbox"
                          className="h-3.5 w-3.5 accent-[var(--arc-brand-atlantean-teal)]"
                          checked={checked}
                          onChange={(e) => {
        ...
        {generated ? (
          <div ref={resultRef} className="mt-8 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 py-1.5 text-[12px] text-white/70 hover:border-[var(--arc-brand-atlantean-teal)]/30 hover:text-[var(--arc-brand-atlantean-teal)]"
                >
                  {copied ? (
            ...
            <pre className="max-h-[480px] overflow-auto rounded-xl border border-white/[0.08] bg-[var(--arc-cosmic-void)]/90 p-4 font-mono text-[12.5px] leading-relaxed text-[var(--arc-text-primary)]">
