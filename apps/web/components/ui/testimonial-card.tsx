      ...
      return (
        ...
        >
          <div className="space-y-4">
            <div className="h-4 w-12 bg-text-muted/20 rounded-lg" />
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-2">
                <div className="h-3 w-24 bg-text-muted/20 rounded-lg" />
                <div className="h-2 w-32 bg-text-muted/15 rounded-lg" />
              </div>
            </div>
          </div>
        </div>
