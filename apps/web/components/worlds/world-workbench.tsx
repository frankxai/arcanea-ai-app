    ...
    <section className={styles.hero} aria-labelledby="home-title">
      <div className={styles.intro}>
        ...
        <p className={styles.boundary}>
          Preview a draft first. Sign in to save it privately to your account.
        </p>
      </div>
            ...
            <div className={styles.entries}>
              ...
              <article>
                ...
                <div>
                  ...
                  <p>
                    Couriers moor their ships in the cooling corona. Each
                    arrival shortens the star&apos;s remaining life.
                  </p>
                </div>
              </article>
            </div>
