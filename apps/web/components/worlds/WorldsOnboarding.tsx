      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        ...
        >
            ...
            {STEPS.map((_, i) => (
              <div
                ...
                className={`w-2 h-2 rounded-full transition-all duration-200 ${
                  i === step
                    ? 'bg-[var(--arc-brand-atlantean-teal)] scale-110'
                    : 'bg-white/15'
                }`}
              />
            ))}
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              onClick={next}
              className="px-5 py-2 text-xs font-medium rounded-lg bg-[var(--arc-brand-atlantean-teal)]/15 border border-[var(--arc-brand-atlantean-teal)]/30 text-[var(--arc-brand-atlantean-teal)] hover:bg-[var(--arc-brand-atlantean-teal)]/25 transition-all"
            >
