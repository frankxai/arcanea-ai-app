...
## Acceptance Criteria
- Objective: Every queued Arcanea creation brief is generated on its correct engine lane, ledgered, gated at 30 points, and approved assets are promoted with gallery-ready sidecars
- Gate:
```bash
