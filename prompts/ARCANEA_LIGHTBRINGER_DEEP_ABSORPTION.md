...
**Phase 0 — Lightbringer Naming Ledger LOCK-IN (Haiku, mechanical).** Read `.arcanea/lore/LIGHTBRINGER_NAMING_LEDGER.md` (authored 2026-04-28). Confirm the locked Arcanea-replacement glossary with Frank if he hasn't pre-approved (Lumen / Tower of Refracted Light / Refracted Council / First Refracted / Refraction Trial / Refracted Guard / Eleven Cards). Once approved, every subsequent phase USES these locked names — no improvisation. The ledger is the IP-protective gate every other phase passes through. Commit any Frank-approved revisions to the ledger; otherwise no commit needed at this phase.
...
**Phase 2 — Lumen Material Taxonomy (Opus, novel architecture).** Author `.arcanea/lore/LUMEN_MATERIAL_TAXONOMY.md` (~3-5K words). Use the LOCKED name **Lumen** (per Phase 0 ledger). Full per-color material property table (Sub-red Lumen, Red Lumen, Orange Lumen, Yellow Lumen, Green Lumen, Blue Lumen, Super-violet Lumen, Chi Lumen, Paryl Lumen, Anti-Lumen / Shadow-Lumen, White Lumen / Lumina-substance). Tie to Tier 8 Materials canon via cross-reference (the existing Vael Crystals / Luminor Metals / Nero Shards taxonomy gets a fourth class — **Lumen** as drafted-light material). Commit + push + verify.

**Phase 3 — The Tower of Refracted Light (Opus, novel architecture).** Author `.arcanea/lore/TOWER_OF_REFRACTED_LIGHT.md` (~5-7K words). Architect within House Synthesis the full institution using the LOCKED Arcanea names: **The Tower of Refracted Light** (the institutional building), eleven sub-spires per frequency (one per Gate plus the central Source-spire), **The Refracted Council** (one drafter per color holds a seat — governance body), the **Discipulus** rank structure (Apprentice → Discipulus → Bichrome Adept → Polychrome → Prism candidate → White Aspirant), **The Refraction Trial** (admission ritual), **The First Refracted** (highest leadership title), **Promachos** (battlefield-protection title — repurposed per ledger). Commit + push + verify.
...
**Phase 6 — The Eleven Cards Game (Sonnet, world-design).** Author `.arcanea/lore/THE_ELEVEN_CARDS.md` (~2-3K words). Use the LOCKED name **The Eleven Cards** (per Phase 0 ledger). Design Arcanea's in-world card-and-strategy game — woven into the political/strategic spine of House Synthesis culture. Cards = the nine drafter-colors as historical Refracted figures, plus the Source-card (Prism State) and the White-card (Architect / Lumina-touch). Game mechanics, lore deck, cultural significance. Commit + push + verify.

**Phase 7 — The Refracted Guard (Sonnet, crew design).** Author `.arcanea/lore/REFRACTED_GUARD.md` (~2-3K words). Design Arcanea's elite protective unit using the LOCKED ledger name **The Refracted Guard** — recruited from polychrome Discipuli, sworn to protect the First Refracted and the Tower of Refracted Light. Structure, induction ritual, signature gear (Lumen-forged armor and blades — NO ka'karon-equivalent borrowing per the ledger), cultural weight. Tie to existing Starbound Crews canon. Commit + push + verify.
