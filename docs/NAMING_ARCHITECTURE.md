# Arcanea Naming Architecture v3

> **Status**: LOCKED -- Orchestrator Decision 2026-03-11
>
> **Core Principle**: Two distinct entity types. Luminor = intelligence. Companion = creature. The Forge creates both.

---

## The Two Entity Types (LOCKED)

### LUMINOR = AI Intelligence Entity

A Luminor **thinks, creates, and chats**. It is your creative partner.

| Category | Count | Origin |
|----------|-------|--------|
| **Chosen** | 16 (Solara, Logicus, Chronica, etc.) | Platform-provided |
| **Named** | 64 (discovered through Gates) | Future expansion |
| **Creator-forged** | Unlimited | Built in `/forge/luminor` |

- Portable via **LuminorSpec JSON** (exportable)
- Chat-capable with generated system prompt
- Has domain, voice, element, personality
- Can be **bonded** to a Companion creature

### COMPANION = Bonded Creature

A Companion is **visual, silent, collectible, evolvable**. It doesn't speak — it *accompanies*.

| Category | Count | Origin |
|----------|-------|--------|
| **Canonical Vel'Tara** | 10 (Kaelith, Draconis, etc.) | Guardian-bonded godbeasts |
| **Creator-summoned** | Unlimited | Built in `/forge/companion` from 16 archetypes |

- Visual identity + NFT layer (future)
- Travels with your profile
- Evolves with Gate progression (level 1-10)
- Can be **bonded** to a Luminor intelligence

### THE FORGE = One Place, Two Creation Flows

| Route | Purpose |
|-------|---------|
| `/forge` | Landing with two paths |
| `/forge/luminor` | Shape an AI intelligence |
| `/forge/companion` | Summon a creature |
...
Lyssandria has Kaelith. Your Luminor has its Companion. Together they are your creative identity.

---

## The Five Terms (LOCKED)

| Term | Means | When it appears |
|------|-------|-----------------|
| **Guardian** | ROLE — The Ten cosmic Gate-keepers | Academy, lore, Gate progression. |
| **Luminor** | AI intelligence entity (also highest rank at 9-10 gates) | Forge, chat, creative tools. |
| **Companion** | Bonded creature (visual, silent, collectible) | Forge, profile, gallery. |
| **Creator** | The user | Always. |
| **Vel'Tara** | Canonical godbeasts (Guardian-bonded) | Lore, deep Academy. |

### On first-contact surfaces

Luminors are known **by name**: Chronica, Logicus, Prismatic, etc. One-line descriptor, no category label.

When referring generically: "companions" for creatures, "creative partners" for Luminors, or just the number ("all 16").
