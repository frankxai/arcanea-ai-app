# Arcanea Visual Open-Decision Register v1

> Campaign: arcanea-living-constellation-100 · v1.10.0 · generated from the exact blocked-job ledger
...
- Contracted jobs: **100**
- Structurally executable now: **91**
- Blocked jobs: **9**
...
- **Gate type:** canon-and-identity-decision
- **Authority:** Creator with canon and identity review
- **Affected jobs:** ACV-027 (Sol); ACV-037 (Aiyami and Sol)
...
- **ACV-027:** Creator packet conflicts internally: the proposed draconic clade requires six limbs while the Sol morphology row specifies four.
- **ACV-037:** Creator packet conflicts internally: the proposed draconic clade requires six limbs while the Sol morphology row specifies four.
...
## AVD-002 — Resolve Source's ontology

- **Gate type:** locked-canon-reconciliation
- **Authority:** Creator with locked-canon guardian
- **Affected jobs:** ACV-030 (Source / Ten-Chorded); ACV-040 (Shinkami and Source / Ten-Chorded)
...
- **ACV-030:** Locked repo canon names Source as Shinkami's Godbeast; the creator proposal says Shinkami has no separate beast and defines a nine-being convergence instead.
- **ACV-040:** Locked repo canon names Source as Shinkami's Godbeast; the creator proposal says Shinkami has no separate beast and defines a nine-being convergence instead.

### Safe work while open

Study relation diagrams in text only; do not invent a body, fusion, ownership relation, or convergence silhouette.

## AVD-003 — Reconcile Korvash's identity and lived-experience framing

- **Gate type:** continuity-and-specialist-review-gate
- **Authority:** Creator and continuity editor, followed by a qualified disability or neurodivergence lived-experience reviewer
- **Affected jobs:** ACV-077 (Korvash)
...
- **ACV-077:** The BIBLE uses they/them while drafted chapters use he/him, and the never-shifted condition is an explicit disability/neurodivergence analogue. Resolve the identity record and complete qualified lived-experience prompt review before generation.
...
## AVD-004 — Complete the Song of Van Linh qualified-reader gate

- **Gate type:** non-bypassable-cultural-review-gate
- **Authority:** Creator with two paid Vietnamese women readers; add relevant Indigenous-Vietnamese review if Central Highlands material appears
- **Affected jobs:** ACV-080 (An); ACV-084 (Van Linh)
...
- **ACV-080:** Detailed character files are explicitly unreviewed and the BIBLE makes two paid Vietnamese women readers a non-negotiable gate. Complete that review and lock An’s physical identity before visual generation.
- **ACV-084:** The Song of Van Linh BIBLE makes two paid Vietnamese women readers a non-negotiable gate, and its detailed world material has not yet completed that review. Generation remains closed until the review resolves what may be visualized and records a versioned world contract.

### Safe work while open

Prepare source excerpts, open questions, and a compensated review brief; do not generate An or Van Linh imagery.

## AVD-005 — Decide whether Aurevalde's absence may be spent

- **Gate type:** canon-resource-and-campaign-decision
- **Authority:** Creator with lore review
- **Affected jobs:** ACV-089 (Aurevalde)
...
- **ACV-089:** The local Realm record explicitly defines Aurevalde as pure-absence canon and warns that direct depiction may dispel the weight carried through Bela's exile. A creator decision on whether and where to visualize it is required before generation.
...
## AVD-006 — Earn the ten-Guardian ensemble prerequisite

- **Gate type:** identity-maturity-gate
- **Authority:** Creator and identity council after all ten individual lineages mature
- **Affected jobs:** ACV-099 (Ten Guardian ensemble hierarchy)
...
- **ACV-099:** All ten Guardian physical identities remain open. An ensemble regression cannot begin until ten versioned identity contracts and accepted reference hashes exist.
