/**
 * Vendored from dashersw/liquid-glass-js (MIT License).
 * Source: https://github.com/dashersw/liquid-glass-js
 * Vendored verbatim 2026-07-03 -- do not hand-edit; re-vendor from upstream instead.
 * Intake logged in claude-skills-library/registries/design-assets.json.
 *
 * Plain classic (non-module) script -- top-level `class` declarations below are
 * NOT attached to `window`; see ../bridge.js for how this package exposes them.
 */
class Container {
  static instances = []
