...
function invokeAwakened(args: string[]) {
...
function invokeSkill(args: string[]) {
...
function switchPlatform(args: string[]) {
  ...
  if (platform === 'claude') console.log('   ANTHROPIC_API_KEY');
  if (platform === 'gemini') console.log('   GEMINI_API_KEY');
  if (platform === 'codex') console.log('   OPENAI_API_KEY');
}
