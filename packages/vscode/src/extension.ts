...
const LORE_INDEX: SearchResult[] = [
  ...
  { label: 'Elara', description: 'Guardian of Shift Gate. Godbeast: Vaelith. Void, 852 Hz. Reframer.' },
  { label: 'Vaelith', description: 'Godbeast of Elara. Shift Gate, Void element.' },
  ...
  { label: 'Shinkami', description: 'Guardian of Source Gate. Godbeast: Amaterasu. Void, 1111 Hz. Origin.' },
  { label: 'Amaterasu', description: 'Godbeast of Shinkami. Source Gate. The great light of heaven.' },
