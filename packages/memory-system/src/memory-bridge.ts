...
export class MemoryBridge {
  ...
  constructor(config?: BridgeConfig) {
    ...
    const storagePath =
      config?.vaultStoragePath ?? join(cwd, ".arcanea", "memory");
    this.cfg = {
      ...
      sessionHeader:
        config?.sessionHeader ?? "# Arcanea Memory — Starlight Vaults",
    };
  }
  ...
  sync(): SyncResult {
    ...
    sections.push("");
    sections.push(
      "> Auto-generated by Starlight Vaults. Edit the source vaults, not this file.",
    );
    sections.push("");
