...
export const skillsByGate: Record<GateName, Skill[]> = {
...
export const allSkills: Skill[] = Object.values(skillsByGate).flat();
...
// Get skills by gate
export function getSkillsByGate(gate: GateName): Skill[] {
