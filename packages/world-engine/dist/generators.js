 ...
 */
import { ELEMENTS, HOUSES, GUARDIANS, GODBEASTS, NAME_ROOTS, NAME_SUFFIXES, getRankFromGates, } from "./canon.js";
// ── Internal helpers ─────────────────────────────────────────────────────────
...
export function pickMultiple(arr, count) {
...
// ── Magic Ability ────────────────────────────────────────────────────────────
export function generateMagicAbility(options) {
...
export function generateLocation(options = {}) {
    ...
    const features = alignment === "light"
...
// ── Creature ─────────────────────────────────────────────────────────────────
export function generateCreature(options = {}) {
...
// ── Story Prompt ─────────────────────────────────────────────────────────────
export function generateStoryPrompt(options = {}) {
