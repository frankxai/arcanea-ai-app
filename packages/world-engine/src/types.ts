...
// ── Creation Graph types (copied from arcanea-mcp, stripped of MCP deps) ──
...
// ── Chosen Responsibility and Right Use types ────────────────────────────────

export type DriftFace =
  | "attention_collapse"
  | "synthetic_confusion"
  | "creative_amnesia"
  | "isolation"
...
export type CreatureReferenceMode =
  | "original"
  | "public_domain_adaptation"
  | "factual_reference";

export type CreatureAtlasStatus =
  | "seed"
  | "draft"
  | "review"
  | "approved"
...
export type CreatureImageGenerationPolicy =
  | "allowed_original_variant"
  | "prompt_only"
  | "licensed_only"
  | "blocked";

export type CreatureRelationshipType =
  | "source_archetype"
  | "same_source_world"
  | "ecological_neighbor"
  | "rival"
...
// Dungeon Atlas and Resonance Vault types

export type DungeonRightsTier =
  | "original_arcanea"
  | "public_domain"
  | "open_rules"
  | "licensed"
...
export type DungeonReferenceMode =
  | "original"
  | "public_domain_adaptation"
  | "open_rules_reference"
  | "factual_reference";

export type DungeonAtlasStatus =
  | "seed"
  | "draft"
  | "review"
  | "approved"
...
export type DungeonGenerationPolicy =
  | "allowed_original_variant"
  | "prompt_only"
  | "licensed_only"
  | "blocked";
...
export type DungeonFormatTarget =
  | "game"
  | "anime"
  | "fantasy_book"
  | "author_toolkit"
...
export type DungeonObjectiveType =
  | "scout"
  | "solve"
  | "survive"
  | "gather"
...
export type DungeonMaterialClass =
  | "vael_crystal"
  | "luminor_metal"
  | "nero_shard"
  | "memory_relic"
