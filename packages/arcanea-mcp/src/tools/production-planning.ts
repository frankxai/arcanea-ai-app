...
function json(data: unknown): TextEnvelope {
...
function titleFromIdea(idea: string, fallback: string): string {
...
function basePacket(kind: string, idea: string, audience?: string) {
  return {
    kind,
...
export const WORKFLOW_RECIPES: Record<RecipeId, object> = {
  book_to_publish: {
...
export function planWorld(args: { idea: string; audience?: string; tone?: string; scope?: string }): TextEnvelope {
...
export function planBook(args: { idea: string; audience?: string; format?: string; voice?: string }): TextEnvelope {
...
export function planGame(args: { idea: string; audience?: string; engine?: string; playStyle?: string }): TextEnvelope {
...
export function planMusicProject(args: { idea: string; audience?: string; genre?: string; releaseType?: string }): TextEnvelope {
...
export function planCinematicScene(args: { idea: string; audience?: string; duration?: string; format?: string }): TextEnvelope {
...
export function listArcaneaStudios(): TextEnvelope {
  return json({ studios: ARC_STUDIOS });
}

export function getWorkflowRecipe(args: { recipe: RecipeId }): TextEnvelope {
  return json({
    recipe: args.recipe,
    ...(WORKFLOW_RECIPES[args.recipe] as object),
  });
}
