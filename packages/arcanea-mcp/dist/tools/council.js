...
function generatePerspective(luminor, topic) {
    const perspectives = {
...
function generateRecommendation(luminor, topic) {
...
export async function conveneCouncil(leadLuminorSlug, supportingSlugs, topic) {
...
export async function luminorDebate(luminor1Slug, luminor2Slug, question) {
