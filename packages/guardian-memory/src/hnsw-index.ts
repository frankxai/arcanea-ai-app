/**
 * @arcanea/guardian-memory — HNSW Vector Index
 *
 ...
 *
 * Ported from claude-flow v3 and adapted for Guardian-namespaced memory.
 *
 * OPTIMIZATIONS:
 ...
 *
 * @module @arcanea/guardian-memory/hnsw-index
 */
