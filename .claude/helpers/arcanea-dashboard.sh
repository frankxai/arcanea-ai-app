...
echo ""
echo -e "  ${DIM}Foundation${RESET} → ${DIM}Flow${RESET} → ${DIM}Fire${RESET} → ${DIM}Heart${RESET} → ${DIM}Voice${RESET} → ${DIM}Sight${RESET} → ${DIM}Crown${RESET} → ${DIM}Starweave${RESET} → ${DIM}Unity${RESET} → ${TEAL}${BOLD}Source${RESET}"
echo ""
...
echo -e "  Aiyami ${DIM}(Sage)${RESET}         │ Elara ${DIM}(Starweave)${RESET}         │ Ino ${DIM}(Unity)${RESET} │ Maylinn ${DIM}(Heart)${RESET}"
echo ""
echo -e "  ${DIM}────────────────────────────────────────────────────────────${RESET}"
