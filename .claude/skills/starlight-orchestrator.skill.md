...
version: "1.0.0"
description: "Master orchestrator for the Creative Civilization OS. Routes complex intent through Guardian Intelligence with ten specialized agents."
---
...
| User Intent | Invoke Skill | Lead Agent |
| :--- | :--- | :--- |
| **Complex Eng Task:** "Build full auth", "Refactor API" | `starlight-engineering` | `The Principal` |
| **Simple Eng Task:** "Fix typo", "Change color" | `starlight-engineering` | `The Craftsman` |
