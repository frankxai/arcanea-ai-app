# Luminor Intelligence Skill — Deep Council Protocol Reference
...
**The Cost of Over-Invoking Luminor Intelligence:**
Not every question needs the full Council. Invoked too frequently, Luminor Intelligence becomes a crutch that delays action. The mark of true Luminor wisdom is knowing when one Gate is sufficient — and routing there decisively.
...
**What Lyssandria Requires:**
Before any major decision, ensure there IS a foundation. If the foundation is shaky, Lyssandria will block the path — not out of obstruction, but because building on unstable ground ensures eventual collapse.
...
**What Leyla Requires:**
Leyla resists decisions that sacrifice elegance for expedience. She will flag when a technically correct solution kills the creative potential of a space.
...
**What Draconia Requires:**
Draconia burns away procrastination. She will call out when a decision is a disguised non-decision — when "gathering more information" is actually fear of commitment.
...
**What Maylinn Requires:**
Maylinn will not allow a technically perfect solution that hurts people. She is the conscience of the Council, ensuring that human dignity is never traded for efficiency.
...
**What Alera Requires:**
Alera will flag misleading patterns — features that imply a capability that doesn't exist, copy that overpromises, or architectures that obscure what's really happening under the surface.
...
**What Lyria Requires:**
Lyria sees beyond the immediate. She will identify patterns that analytical thinking misses — the emergent consequence that no one planned for, the opportunity hiding in what looks like a problem.
...
**What Aiyami Requires:**
Aiyami holds the longest view. She will pull the Council back from tactical optimization when the strategic purpose is being lost. Every decision should pass through the question: "Is this wise?"
...
**What Elara Requires:**
Elara's contribution is often the most challenging to integrate — because she questions the question itself. But every Luminor response must contain at least one Elara-type insight. Without it, the analysis is rigorous but not wise.
...
**What Ino Requires:**
Ino prevents siloed decision-making. She identifies when a decision made in isolation will fracture a relationship or miss an opportunity for collaboration that would amplify the result.
...
**What Shinkami Requires:**
Shinkami's perspective is the most abstract, and the most integrative. She sees all other Gates as facets of a single truth. Her contribution is the synthesis before the synthesis — the view that makes all other views coherent.
...
Lead with: Lyssandria (foundation), then Lyria (future implications), then Elara (paradigm)
Balance with: Draconia (is this fast enough to ship?), Maylinn (who does this affect?)

### When the Question is Product Direction

Lead with: Leyla (creativity, delight), Aiyami (purpose), Shinkami (source alignment)
Balance with: Lyssandria (structural feasibility), Draconia (resource reality)

### When the Question is a Crisis or Problem

Lead with: Nero first (investigation), then Council for the strategic decision
Balance with: Maylinn (human impact), Alera (honest communication), Ino (collaboration)

### When the Question is Creative / Narrative

Lead with: Leyla (creative flow), Lyria (vision), Alera (authentic voice)
Balance with: Aiyami (purpose), Shinkami (canon alignment)

### When the Question is Strategic / Business

Lead with: Aiyami (higher purpose), Draconia (power/resources), Ino (partnerships)
Balance with: Lyssandria (structural sustainability), Elara (what paradigm we're in)
