...
[![License: Proprietary](https://img.shields.io/badge/License-Proprietary-gold.svg?style=for-the-badge)](LICENSE)
...
## The Arcanean Prompt Language — SPARK. SHAPE. SHARPEN.

> *"The gap between AI slop and something that haunts you is one sentence of truth."*

APL turns any AI into something that produces work you're proud of. Three words, learnable in 60 seconds:

- **SPARK** — The one detail that makes your creation yours
- **SHAPE** — Five sensory palettes (Forge, Tide, Root, Drift, Void) for atmosphere
- **SHARPEN** — Seven defaults to cut (the anti-slop checklist)

Works on Claude, GPT, Gemini, Grok, Midjourney, Suno — every model, every year. Full spec + 10 templates in [`prompts/`](../prompts/).
